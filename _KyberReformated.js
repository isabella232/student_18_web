!function (e, t) {
    "object" == typeof exports && "object" == typeof module ? module.exports = t() : "function" == typeof define && define.amd ? define([], t) : "object" == typeof exports ? exports.kyber = t() : e.kyber = t()
    ...
    return function (e) {
        ...
        n.from && n.alloc && n.allocUnsafe && n.allocUnsafeSlow ? e.exports = i : (a(i, t), t.Buffer = o), a(n, o), o.from = function (e, t, r) {
            ...
            !function (e, t) {
                ...
                function s(e, t, r, i) {
                    for (var n = 0, a = Math.min(e.length, r), o = t; o < a; o++) {
                        ...
                        n *= i, n += f >= 49 ? f - 49 + 10 : f >= 17 ? f - 17 + 10 : f
                    }
                    return n
                }
                ...
                a.isBN = function (e) {
                    ...
                    var a, o, f = 0;
                    if ("be" === r) for (n = e.length - 1, a = 0; n >= 0; n -= 3) o = e[n] | e[n - 1] << 8 | e[n - 2] << 16, this.words[a] |= o << f & 67108863, this.words[a + 1] = o >>> 26 - f & 67108863, (f += 24) >= 26 && (f -= 26, a++); else if ("le" === r) for (n = 0, a = 0; n < e.length; n += 3) o = e[n] | e[n + 1] << 8 | e[n + 2] << 16, this.words[a] |= o << f & 67108863, this.words[a + 1] = o >>> 26 - f & 67108863, (f += 24) >= 26 && (f -= 26, a++);
                    return this.strip()
                }, a.prototype._parseHex = function (e, t) {
                    this.length = Math.ceil((e.length - t) / 6), this.words = new Array(this.length);
                    for (var r = 0; r < this.length; r++) this.words[r] = 0;
                    var i, n, a = 0;
                    for (r = e.length - 6, i = 0; r >= t; r -= 6) n = f(e, r, r + 6), this.words[i] |= n << a & 67108863, this.words[i + 1] |= n >>> 26 - a & 4194303, (a += 24) >= 26 && (a -= 26, i++);
                    r + 6 !== t && (n = f(e, t, r + 6), this.words[i] |= n << a & 67108863, this.words[i + 1] |= n >>> 26 - a & 4194303), this.strip()
                }, a.prototype._parseBase = function (e, t, r) {
                    this.words = [0], this.length = 1;
                    for (var i = 0, n = 1; n <= 67108863; n *= t) i++;
                    i--, n = n / t | 0;
                    for (var a = e.length - r, o = a % i, f = Math.min(a, a - o) + r, c = 0, h = r; h < f; h += i) c = s(e, h, h + i, t), this.imuln(n), this.words[0] + c < 67108864 ? this.words[0] += c : this._iaddn(c);
                    if (0 !== o) {
                        var d = 1;
                ...
                function u(e, t, r) {
                    ...
                    r.length = i, i = i - 1 | 0;
                    var n = 0 | e.words[0], a = 0 | t.words[0], o = n * a, f = 67108863 & o, s = o / 67108864 | 0;
                    r.words[0] = f;
                    for (var c = 1; c < i; c++) {
                        for (var h = s >>> 26, d = 67108863 & s, u = Math.min(c, t.length - 1), l = Math.max(0, c - e.length + 1); l <= u; l++) {
                            var p = c - l | 0;
                            h += (o = (n = 0 | e.words[p]) * (a = 0 | t.words[l]) + d) / 67108864 | 0, d = 67108863 & o
                        }
                        r.words[c] = 0 | d, s = 0 | h
                    }
                ...
                a.prototype.toString = function (e, t) {
                    ...
                    if (e = e || 10, t = 0 | t || 1, 16 === e || "hex" === e) {
                        ...
                        for (var n = 0, a = 0, o = 0; o < this.length; o++) {
                            var f = this.words[o], s = (16777215 & (f << n | a)).toString(16);
                    ...
                    if (s) {
                        for (f = 0; !h.isZero(); f++) o = h.andln(255), h.iushrn(8), c[f] = o;
                        for (; f < a; f++) c[f] = 0
                    } else {
                        for (f = 0; f < a - n; f++) c[f] = 0;
                        for (f = 0; !h.isZero(); f++) o = h.andln(255), h.iushrn(8), c[a - f - 1] = o
                    }
                    return c
                ...
                var l = function (e, t, r) {
                    var i, n, a, o = e.words, f = t.words, s = r.words, c = 0, h = 0 | o[0], d = 8191 & h, u = h >>> 13,
                        l = 0 | o[1], p = 8191 & l, b = l >>> 13, y = 0 | o[2], m = 8191 & y, v = y >>> 13,
                        g = 0 | o[3], w = 8191 & g, _ = g >>> 13, S = 0 | o[4], M = 8191 & S, E = S >>> 13,
                        A = 0 | o[5], k = 8191 & A, x = A >>> 13, B = 0 | o[6], I = 8191 & B, R = B >>> 13,
                        P = 0 | o[7], T = 8191 & P, C = P >>> 13, j = 0 | o[8], U = 8191 & j, L = j >>> 13,
                        N = 0 | o[9], D = 8191 & N, O = N >>> 13, z = 0 | f[0], q = 8191 & z, K = z >>> 13,
                        F = 0 | f[1], H = 8191 & F, Y = F >>> 13, V = 0 | f[2], W = 8191 & V, X = V >>> 13,
                        G = 0 | f[3], J = 8191 & G, Z = G >>> 13, $ = 0 | f[4], Q = 8191 & $, ee = $ >>> 13,
                        te = 0 | f[5], re = 8191 & te, ie = te >>> 13, ne = 0 | f[6], ae = 8191 & ne, oe = ne >>> 13,
                        fe = 0 | f[7], se = 8191 & fe, ce = fe >>> 13, he = 0 | f[8], de = 8191 & he, ue = he >>> 13,
                        le = 0 | f[9], pe = 8191 & le, be = le >>> 13;
                    r.negative = e.negative ^ t.negative, r.length = 19;
                    var ye = (c + (i = Math.imul(d, q)) | 0) + ((8191 & (n = (n = Math.imul(d, K)) + Math.imul(u, q) | 0)) << 13) | 0;
                    c = ((a = Math.imul(u, K)) + (n >>> 13) | 0) + (ye >>> 26) | 0, ye &= 67108863, i = Math.imul(p, q), n = (n = Math.imul(p, K)) + Math.imul(b, q) | 0, a = Math.imul(b, K);
                    var me = (c + (i = i + Math.imul(d, H) | 0) | 0) + ((8191 & (n = (n = n + Math.imul(d, Y) | 0) + Math.imul(u, H) | 0)) << 13) | 0;
                    c = ((a = a + Math.imul(u, Y) | 0) + (n >>> 13) | 0) + (me >>> 26) | 0, me &= 67108863, i = Math.imul(m, q), n = (n = Math.imul(m, K)) + Math.imul(v, q) | 0, a = Math.imul(v, K), i = i + Math.imul(p, H) | 0, n = (n = n + Math.imul(p, Y) | 0) + Math.imul(b, H) | 0, a = a + Math.imul(b, Y) | 0;
                    var ve = (c + (i = i + Math.imul(d, W) | 0) | 0) + ((8191 & (n = (n = n + Math.imul(d, X) | 0) + Math.imul(u, W) | 0)) << 13) | 0;
                    c = ((a = a + Math.imul(u, X) | 0) + (n >>> 13) | 0) + (ve >>> 26) | 0, ve &= 67108863, i = Math.imul(w, q), n = (n = Math.imul(w, K)) + Math.imul(_, q) | 0, a = Math.imul(_, K), i = i + Math.imul(m, H) | 0, n = (n = n + Math.imul(m, Y) | 0) + Math.imul(v, H) | 0, a = a + Math.imul(v, Y) | 0, i = i + Math.imul(p, W) | 0, n = (n = n + Math.imul(p, X) | 0) + Math.imul(b, W) | 0, a = a + Math.imul(b, X) | 0;
                    var ge = (c + (i = i + Math.imul(d, J) | 0) | 0) + ((8191 & (n = (n = n + Math.imul(d, Z) | 0) + Math.imul(u, J) | 0)) << 13) | 0;
                    c = ((a = a + Math.imul(u, Z) | 0) + (n >>> 13) | 0) + (ge >>> 26) | 0, ge &= 67108863, i = Math.imul(M, q), n = (n = Math.imul(M, K)) + Math.imul(E, q) | 0, a = Math.imul(E, K), i = i + Math.imul(w, H) | 0, n = (n = n + Math.imul(w, Y) | 0) + Math.imul(_, H) | 0, a = a + Math.imul(_, Y) | 0, i = i + Math.imul(m, W) | 0, n = (n = n + Math.imul(m, X) | 0) + Math.imul(v, W) | 0, a = a + Math.imul(v, X) | 0, i = i + Math.imul(p, J) | 0, n = (n = n + Math.imul(p, Z) | 0) + Math.imul(b, J) | 0, a = a + Math.imul(b, Z) | 0;
                    var we = (c + (i = i + Math.imul(d, Q) | 0) | 0) + ((8191 & (n = (n = n + Math.imul(d, ee) | 0) + Math.imul(u, Q) | 0)) << 13) | 0;
                    c = ((a = a + Math.imul(u, ee) | 0) + (n >>> 13) | 0) + (we >>> 26) | 0, we &= 67108863, i = Math.imul(k, q), n = (n = Math.imul(k, K)) + Math.imul(x, q) | 0, a = Math.imul(x, K), i = i + Math.imul(M, H) | 0, n = (n = n + Math.imul(M, Y) | 0) + Math.imul(E, H) | 0, a = a + Math.imul(E, Y) | 0, i = i + Math.imul(w, W) | 0, n = (n = n + Math.imul(w, X) | 0) + Math.imul(_, W) | 0, a = a + Math.imul(_, X) | 0, i = i + Math.imul(m, J) | 0, n = (n = n + Math.imul(m, Z) | 0) + Math.imul(v, J) | 0, a = a + Math.imul(v, Z) | 0, i = i + Math.imul(p, Q) | 0, n = (n = n + Math.imul(p, ee) | 0) + Math.imul(b, Q) | 0, a = a + Math.imul(b, ee) | 0;
                    var _e = (c + (i = i + Math.imul(d, re) | 0) | 0) + ((8191 & (n = (n = n + Math.imul(d, ie) | 0) + Math.imul(u, re) | 0)) << 13) | 0;
                    c = ((a = a + Math.imul(u, ie) | 0) + (n >>> 13) | 0) + (_e >>> 26) | 0, _e &= 67108863, i = Math.imul(I, q), n = (n = Math.imul(I, K)) + Math.imul(R, q) | 0, a = Math.imul(R, K), i = i + Math.imul(k, H) | 0, n = (n = n + Math.imul(k, Y) | 0) + Math.imul(x, H) | 0, a = a + Math.imul(x, Y) | 0, i = i + Math.imul(M, W) | 0, n = (n = n + Math.imul(M, X) | 0) + Math.imul(E, W) | 0, a = a + Math.imul(E, X) | 0, i = i + Math.imul(w, J) | 0, n = (n = n + Math.imul(w, Z) | 0) + Math.imul(_, J) | 0, a = a + Math.imul(_, Z) | 0, i = i + Math.imul(m, Q) | 0, n = (n = n + Math.imul(m, ee) | 0) + Math.imul(v, Q) | 0, a = a + Math.imul(v, ee) | 0, i = i + Math.imul(p, re) | 0, n = (n = n + Math.imul(p, ie) | 0) + Math.imul(b, re) | 0, a = a + Math.imul(b, ie) | 0;
                    var Se = (c + (i = i + Math.imul(d, ae) | 0) | 0) + ((8191 & (n = (n = n + Math.imul(d, oe) | 0) + Math.imul(u, ae) | 0)) << 13) | 0;
                    c = ((a = a + Math.imul(u, oe) | 0) + (n >>> 13) | 0) + (Se >>> 26) | 0, Se &= 67108863, i = Math.imul(T, q), n = (n = Math.imul(T, K)) + Math.imul(C, q) | 0, a = Math.imul(C, K), i = i + Math.imul(I, H) | 0, n = (n = n + Math.imul(I, Y) | 0) + Math.imul(R, H) | 0, a = a + Math.imul(R, Y) | 0, i = i + Math.imul(k, W) | 0, n = (n = n + Math.imul(k, X) | 0) + Math.imul(x, W) | 0, a = a + Math.imul(x, X) | 0, i = i + Math.imul(M, J) | 0, n = (n = n + Math.imul(M, Z) | 0) + Math.imul(E, J) | 0, a = a + Math.imul(E, Z) | 0, i = i + Math.imul(w, Q) | 0, n = (n = n + Math.imul(w, ee) | 0) + Math.imul(_, Q) | 0, a = a + Math.imul(_, ee) | 0, i = i + Math.imul(m, re) | 0, n = (n = n + Math.imul(m, ie) | 0) + Math.imul(v, re) | 0, a = a + Math.imul(v, ie) | 0, i = i + Math.imul(p, ae) | 0, n = (n = n + Math.imul(p, oe) | 0) + Math.imul(b, ae) | 0, a = a + Math.imul(b, oe) | 0;
                    var Me = (c + (i = i + Math.imul(d, se) | 0) | 0) + ((8191 & (n = (n = n + Math.imul(d, ce) | 0) + Math.imul(u, se) | 0)) << 13) | 0;
                    c = ((a = a + Math.imul(u, ce) | 0) + (n >>> 13) | 0) + (Me >>> 26) | 0, Me &= 67108863, i = Math.imul(U, q), n = (n = Math.imul(U, K)) + Math.imul(L, q) | 0, a = Math.imul(L, K), i = i + Math.imul(T, H) | 0, n = (n = n + Math.imul(T, Y) | 0) + Math.imul(C, H) | 0, a = a + Math.imul(C, Y) | 0, i = i + Math.imul(I, W) | 0, n = (n = n + Math.imul(I, X) | 0) + Math.imul(R, W) | 0, a = a + Math.imul(R, X) | 0, i = i + Math.imul(k, J) | 0, n = (n = n + Math.imul(k, Z) | 0) + Math.imul(x, J) | 0, a = a + Math.imul(x, Z) | 0, i = i + Math.imul(M, Q) | 0, n = (n = n + Math.imul(M, ee) | 0) + Math.imul(E, Q) | 0, a = a + Math.imul(E, ee) | 0, i = i + Math.imul(w, re) | 0, n = (n = n + Math.imul(w, ie) | 0) + Math.imul(_, re) | 0, a = a + Math.imul(_, ie) | 0, i = i + Math.imul(m, ae) | 0, n = (n = n + Math.imul(m, oe) | 0) + Math.imul(v, ae) | 0, a = a + Math.imul(v, oe) | 0, i = i + Math.imul(p, se) | 0, n = (n = n + Math.imul(p, ce) | 0) + Math.imul(b, se) | 0, a = a + Math.imul(b, ce) | 0;
                    var Ee = (c + (i = i + Math.imul(d, de) | 0) | 0) + ((8191 & (n = (n = n + Math.imul(d, ue) | 0) + Math.imul(u, de) | 0)) << 13) | 0;
                    c = ((a = a + Math.imul(u, ue) | 0) + (n >>> 13) | 0) + (Ee >>> 26) | 0, Ee &= 67108863, i = Math.imul(D, q), n = (n = Math.imul(D, K)) + Math.imul(O, q) | 0, a = Math.imul(O, K), i = i + Math.imul(U, H) | 0, n = (n = n + Math.imul(U, Y) | 0) + Math.imul(L, H) | 0, a = a + Math.imul(L, Y) | 0, i = i + Math.imul(T, W) | 0, n = (n = n + Math.imul(T, X) | 0) + Math.imul(C, W) | 0, a = a + Math.imul(C, X) | 0, i = i + Math.imul(I, J) | 0, n = (n = n + Math.imul(I, Z) | 0) + Math.imul(R, J) | 0, a = a + Math.imul(R, Z) | 0, i = i + Math.imul(k, Q) | 0, n = (n = n + Math.imul(k, ee) | 0) + Math.imul(x, Q) | 0, a = a + Math.imul(x, ee) | 0, i = i + Math.imul(M, re) | 0, n = (n = n + Math.imul(M, ie) | 0) + Math.imul(E, re) | 0, a = a + Math.imul(E, ie) | 0, i = i + Math.imul(w, ae) | 0, n = (n = n + Math.imul(w, oe) | 0) + Math.imul(_, ae) | 0, a = a + Math.imul(_, oe) | 0, i = i + Math.imul(m, se) | 0, n = (n = n + Math.imul(m, ce) | 0) + Math.imul(v, se) | 0, a = a + Math.imul(v, ce) | 0, i = i + Math.imul(p, de) | 0, n = (n = n + Math.imul(p, ue) | 0) + Math.imul(b, de) | 0, a = a + Math.imul(b, ue) | 0;
                    var Ae = (c + (i = i + Math.imul(d, pe) | 0) | 0) + ((8191 & (n = (n = n + Math.imul(d, be) | 0) + Math.imul(u, pe) | 0)) << 13) | 0;
                    c = ((a = a + Math.imul(u, be) | 0) + (n >>> 13) | 0) + (Ae >>> 26) | 0, Ae &= 67108863, i = Math.imul(D, H), n = (n = Math.imul(D, Y)) + Math.imul(O, H) | 0, a = Math.imul(O, Y), i = i + Math.imul(U, W) | 0, n = (n = n + Math.imul(U, X) | 0) + Math.imul(L, W) | 0, a = a + Math.imul(L, X) | 0, i = i + Math.imul(T, J) | 0, n = (n = n + Math.imul(T, Z) | 0) + Math.imul(C, J) | 0, a = a + Math.imul(C, Z) | 0, i = i + Math.imul(I, Q) | 0, n = (n = n + Math.imul(I, ee) | 0) + Math.imul(R, Q) | 0, a = a + Math.imul(R, ee) | 0, i = i + Math.imul(k, re) | 0, n = (n = n + Math.imul(k, ie) | 0) + Math.imul(x, re) | 0, a = a + Math.imul(x, ie) | 0, i = i + Math.imul(M, ae) | 0, n = (n = n + Math.imul(M, oe) | 0) + Math.imul(E, ae) | 0, a = a + Math.imul(E, oe) | 0, i = i + Math.imul(w, se) | 0, n = (n = n + Math.imul(w, ce) | 0) + Math.imul(_, se) | 0, a = a + Math.imul(_, ce) | 0, i = i + Math.imul(m, de) | 0, n = (n = n + Math.imul(m, ue) | 0) + Math.imul(v, de) | 0, a = a + Math.imul(v, ue) | 0;
                    var ke = (c + (i = i + Math.imul(p, pe) | 0) | 0) + ((8191 & (n = (n = n + Math.imul(p, be) | 0) + Math.imul(b, pe) | 0)) << 13) | 0;
                    c = ((a = a + Math.imul(b, be) | 0) + (n >>> 13) | 0) + (ke >>> 26) | 0, ke &= 67108863, i = Math.imul(D, W), n = (n = Math.imul(D, X)) + Math.imul(O, W) | 0, a = Math.imul(O, X), i = i + Math.imul(U, J) | 0, n = (n = n + Math.imul(U, Z) | 0) + Math.imul(L, J) | 0, a = a + Math.imul(L, Z) | 0, i = i + Math.imul(T, Q) | 0, n = (n = n + Math.imul(T, ee) | 0) + Math.imul(C, Q) | 0, a = a + Math.imul(C, ee) | 0, i = i + Math.imul(I, re) | 0, n = (n = n + Math.imul(I, ie) | 0) + Math.imul(R, re) | 0, a = a + Math.imul(R, ie) | 0, i = i + Math.imul(k, ae) | 0, n = (n = n + Math.imul(k, oe) | 0) + Math.imul(x, ae) | 0, a = a + Math.imul(x, oe) | 0, i = i + Math.imul(M, se) | 0, n = (n = n + Math.imul(M, ce) | 0) + Math.imul(E, se) | 0, a = a + Math.imul(E, ce) | 0, i = i + Math.imul(w, de) | 0, n = (n = n + Math.imul(w, ue) | 0) + Math.imul(_, de) | 0, a = a + Math.imul(_, ue) | 0;
                    var xe = (c + (i = i + Math.imul(m, pe) | 0) | 0) + ((8191 & (n = (n = n + Math.imul(m, be) | 0) + Math.imul(v, pe) | 0)) << 13) | 0;
                    c = ((a = a + Math.imul(v, be) | 0) + (n >>> 13) | 0) + (xe >>> 26) | 0, xe &= 67108863, i = Math.imul(D, J), n = (n = Math.imul(D, Z)) + Math.imul(O, J) | 0, a = Math.imul(O, Z), i = i + Math.imul(U, Q) | 0, n = (n = n + Math.imul(U, ee) | 0) + Math.imul(L, Q) | 0, a = a + Math.imul(L, ee) | 0, i = i + Math.imul(T, re) | 0, n = (n = n + Math.imul(T, ie) | 0) + Math.imul(C, re) | 0, a = a + Math.imul(C, ie) | 0, i = i + Math.imul(I, ae) | 0, n = (n = n + Math.imul(I, oe) | 0) + Math.imul(R, ae) | 0, a = a + Math.imul(R, oe) | 0, i = i + Math.imul(k, se) | 0, n = (n = n + Math.imul(k, ce) | 0) + Math.imul(x, se) | 0, a = a + Math.imul(x, ce) | 0, i = i + Math.imul(M, de) | 0, n = (n = n + Math.imul(M, ue) | 0) + Math.imul(E, de) | 0, a = a + Math.imul(E, ue) | 0;
                    var Be = (c + (i = i + Math.imul(w, pe) | 0) | 0) + ((8191 & (n = (n = n + Math.imul(w, be) | 0) + Math.imul(_, pe) | 0)) << 13) | 0;
                    c = ((a = a + Math.imul(_, be) | 0) + (n >>> 13) | 0) + (Be >>> 26) | 0, Be &= 67108863, i = Math.imul(D, Q), n = (n = Math.imul(D, ee)) + Math.imul(O, Q) | 0, a = Math.imul(O, ee), i = i + Math.imul(U, re) | 0, n = (n = n + Math.imul(U, ie) | 0) + Math.imul(L, re) | 0, a = a + Math.imul(L, ie) | 0, i = i + Math.imul(T, ae) | 0, n = (n = n + Math.imul(T, oe) | 0) + Math.imul(C, ae) | 0, a = a + Math.imul(C, oe) | 0, i = i + Math.imul(I, se) | 0, n = (n = n + Math.imul(I, ce) | 0) + Math.imul(R, se) | 0, a = a + Math.imul(R, ce) | 0, i = i + Math.imul(k, de) | 0, n = (n = n + Math.imul(k, ue) | 0) + Math.imul(x, de) | 0, a = a + Math.imul(x, ue) | 0;
                    var Ie = (c + (i = i + Math.imul(M, pe) | 0) | 0) + ((8191 & (n = (n = n + Math.imul(M, be) | 0) + Math.imul(E, pe) | 0)) << 13) | 0;
                    c = ((a = a + Math.imul(E, be) | 0) + (n >>> 13) | 0) + (Ie >>> 26) | 0, Ie &= 67108863, i = Math.imul(D, re), n = (n = Math.imul(D, ie)) + Math.imul(O, re) | 0, a = Math.imul(O, ie), i = i + Math.imul(U, ae) | 0, n = (n = n + Math.imul(U, oe) | 0) + Math.imul(L, ae) | 0, a = a + Math.imul(L, oe) | 0, i = i + Math.imul(T, se) | 0, n = (n = n + Math.imul(T, ce) | 0) + Math.imul(C, se) | 0, a = a + Math.imul(C, ce) | 0, i = i + Math.imul(I, de) | 0, n = (n = n + Math.imul(I, ue) | 0) + Math.imul(R, de) | 0, a = a + Math.imul(R, ue) | 0;
                    var Re = (c + (i = i + Math.imul(k, pe) | 0) | 0) + ((8191 & (n = (n = n + Math.imul(k, be) | 0) + Math.imul(x, pe) | 0)) << 13) | 0;
                    c = ((a = a + Math.imul(x, be) | 0) + (n >>> 13) | 0) + (Re >>> 26) | 0, Re &= 67108863, i = Math.imul(D, ae), n = (n = Math.imul(D, oe)) + Math.imul(O, ae) | 0, a = Math.imul(O, oe), i = i + Math.imul(U, se) | 0, n = (n = n + Math.imul(U, ce) | 0) + Math.imul(L, se) | 0, a = a + Math.imul(L, ce) | 0, i = i + Math.imul(T, de) | 0, n = (n = n + Math.imul(T, ue) | 0) + Math.imul(C, de) | 0, a = a + Math.imul(C, ue) | 0;
                    var Pe = (c + (i = i + Math.imul(I, pe) | 0) | 0) + ((8191 & (n = (n = n + Math.imul(I, be) | 0) + Math.imul(R, pe) | 0)) << 13) | 0;
                    c = ((a = a + Math.imul(R, be) | 0) + (n >>> 13) | 0) + (Pe >>> 26) | 0, Pe &= 67108863, i = Math.imul(D, se), n = (n = Math.imul(D, ce)) + Math.imul(O, se) | 0, a = Math.imul(O, ce), i = i + Math.imul(U, de) | 0, n = (n = n + Math.imul(U, ue) | 0) + Math.imul(L, de) | 0, a = a + Math.imul(L, ue) | 0;
                    var Te = (c + (i = i + Math.imul(T, pe) | 0) | 0) + ((8191 & (n = (n = n + Math.imul(T, be) | 0) + Math.imul(C, pe) | 0)) << 13) | 0;
                    c = ((a = a + Math.imul(C, be) | 0) + (n >>> 13) | 0) + (Te >>> 26) | 0, Te &= 67108863, i = Math.imul(D, de), n = (n = Math.imul(D, ue)) + Math.imul(O, de) | 0, a = Math.imul(O, ue);
                    var Ce = (c + (i = i + Math.imul(U, pe) | 0) | 0) + ((8191 & (n = (n = n + Math.imul(U, be) | 0) + Math.imul(L, pe) | 0)) << 13) | 0;
                    c = ((a = a + Math.imul(L, be) | 0) + (n >>> 13) | 0) + (Ce >>> 26) | 0, Ce &= 67108863;
                    var je = (c + (i = Math.imul(D, pe)) | 0) + ((8191 & (n = (n = Math.imul(D, be)) + Math.imul(O, pe) | 0)) << 13) | 0;
                    return c = ((a = Math.imul(O, be)) + (n >>> 13) | 0) + (je >>> 26) | 0, je &= 67108863, s[0] = ye, s[1] = me, s[2] = ve, s[3] = ge, s[4] = we, s[5] = _e, s[6] = Se, s[7] = Me, s[8] = Ee, s[9] = Ae, s[10] = ke, s[11] = xe, s[12] = Be, s[13] = Ie, s[14] = Re, s[15] = Pe, s[16] = Te, s[17] = Ce, s[18] = je, 0 !== c && (s[19] = c, r.length++), r
                };
                ...
                Math.imul || (l = u), a.prototype.mulTo = function (e, t) {
                    ...
                    return 10 === this.length && 10 === e.length ? l(this, e, t) : r < 63 ? u(this, e, t) : r < 1024 ? function (e, t, r) {
                        ...
                        for (var i = 0, n = 0, a = 0; a < r.length - 1; a++) {
                            var o = n;
                            n = 0;
                            for (var f = 67108863 & i, s = Math.min(a, t.length - 1), c = Math.max(0, a - e.length + 1); c <= s; c++) {
                                var h = a - c, d = (0 | e.words[h]) * (0 | t.words[c]), u = 67108863 & d;
                                f = 67108863 & (u = u + f | 0), n += (o = (o = o + (d / 67108864 | 0) | 0) + (u >>> 26) | 0) >>> 26, o &= 67108863
                            }
                            r.words[a] = f, i = o, o = n
                        }
                    ...
                    for (var o = 1; o < n; o <<= 1) for (var f = o << 1, s = Math.cos(2 * Math.PI / f), c = Math.sin(2 * Math.PI / f), h = 0; h < n; h += f) for (var d = s, u = c, l = 0; l < o; l++) {
                        var p = r[h + l], b = i[h + l], y = r[h + l + o], m = i[h + l + o], v = d * y - u * m;
                        m = d * m + u * y, y = v, r[h + l] = p + y, i[h + l] = b + m, r[h + l + o] = p - y, i[h + l + o] = b - m, l !== f && (v = s * d - c * u, u = s * u + c * d, d = v)
                    }
                    ...
                    var i = 2 * this.guessLen13b(e.length, t.length), n = this.makeRBT(i), a = this.stub(i),
                        o = new Array(i), f = new Array(i), s = new Array(i), c = new Array(i), h = new Array(i),
                        d = new Array(i), u = r.words;
                    u.length = i, this.convert13b(e.words, e.length, o, i), this.convert13b(t.words, t.length, c, i), this.transform(o, a, f, s, i, n), this.transform(c, a, h, d, i, n);
                    for (var l = 0; l < i; l++) {
                        var p = f[l] * h[l] - s[l] * d[l];
                        s[l] = f[l] * d[l] + s[l] * h[l], f[l] = p
                    }
                    return this.conjugate(f, s, i), this.transform(f, s, u, a, i, n), this.conjugate(u, a, i), this.normalize13b(u, i), r.negative = e.negative ^ t.negative, r.length = e.length + t.length, r.strip()
                    ...
                    if (0 !== r) {
                        ...
                        for (t = 0; t < this.length; t++) {
                            var f = this.words[t] & a, s = (0 | this.words[t]) - f << r;
                    ...
                    var a = e % 26, o = Math.min((e - a) / 26, this.length), f = 67108863 ^ 67108863 >>> a << a, s = r;
                    ...
                    for (n = 0; n < e.length; n++) {
                        ...
                        var s = (0 | e.words[n]) * t;
                        f = ((a -= 67108863 & s) >> 26) - (s / 67108864 | 0), this.words[n + r] = 67108863 & a
                    }
                    ...
                    var f, s = i.length - n.length;
                    if ("mod" !== t) {
                        (f = new a(null)).length = s + 1, f.words = new Array(f.length);
                        for (var c = 0; c < f.length; c++) f.words[c] = 0
                    }
                    var h = i.clone()._ishlnsubmul(n, 1, s);
                    0 === h.negative && (i = h, f && (f.words[s] = 1));
                    for (var d = s - 1; d >= 0; d--) {
                        var u = 67108864 * (0 | i.words[n.length + d]) + (0 | i.words[n.length + d - 1]);
                        for (u = Math.min(u / o | 0, 67108863), i._ishlnsubmul(n, u, d); 0 !== i.negative;) u--, i.negative = 0, i._ishlnsubmul(n, 1, d), i.isZero() || (i.negative ^= 1);
                        f && (f.words[d] = u)
                    }
                    return f && f.strip(), i.strip(), "div" !== t && 0 !== r && i.iushrn(r), {div: f || null, mod: i}
                }, a.prototype.divmod = function (e, t, r) {
                    return i(!e.isZero()), this.isZero() ? {
                        div: new a(0),
                        mod: new a(0)
                    } : 0 !== this.negative && 0 === e.negative ? (f = this.neg().divmod(e, t), "mod" !== t && (n = f.div.neg()), "div" !== t && (o = f.mod.neg(), r && 0 !== o.negative && o.iadd(e)), {
                        div: n,
                        mod: o
                    }) : 0 === this.negative && 0 !== e.negative ? (f = this.divmod(e.neg(), t), "mod" !== t && (n = f.div.neg()), {
                        div: n,
                        mod: f.mod
                    }) : 0 != (this.negative & e.negative) ? (f = this.neg().divmod(e.neg(), t), "div" !== t && (o = f.mod.neg(), r && 0 !== o.negative && o.isub(e)), {
                        div: f.div,
                        mod: o
                    ...
                    for (var n = new a(1), o = new a(0), f = new a(0), s = new a(1), c = 0; t.isEven() && r.isEven();) t.iushrn(1), r.iushrn(1), ++c;
                    for (var h = r.clone(), d = t.clone(); !t.isZero();) {
                        for (var u = 0, l = 1; 0 == (t.words[0] & l) && u < 26; ++u, l <<= 1) ;
                        if (u > 0) for (t.iushrn(u); u-- > 0;) (n.isOdd() || o.isOdd()) && (n.iadd(h), o.isub(d)), n.iushrn(1), o.iushrn(1);
                        for (var p = 0, b = 1; 0 == (r.words[0] & b) && p < 26; ++p, b <<= 1) ;
                        if (p > 0) for (r.iushrn(p); p-- > 0;) (f.isOdd() || s.isOdd()) && (f.iadd(h), s.isub(d)), f.iushrn(1), s.iushrn(1);
                        t.cmp(r) >= 0 ? (t.isub(r), n.isub(f), o.isub(s)) : (r.isub(t), f.isub(n), s.isub(o))
                    }
                    ...
                    var t = this, r = e.clone();
                    t = 0 !== t.negative ? t.umod(e) : t.clone();
                    for (var n, o = new a(1), f = new a(0), s = r.clone(); t.cmpn(1) > 0 && r.cmpn(1) > 0;) {
                        ...
                        if (d > 0) for (r.iushrn(d); d-- > 0;) f.isOdd() && f.iadd(s), f.iushrn(1);
                        t.cmp(r) >= 0 ? (t.isub(r), o.isub(f)) : (r.isub(t), f.isub(o))
                    }
                    return (n = 0 === t.cmpn(1) ? o : f).cmpn(0) < 0 && n.iadd(e), n
                ...
                m.prototype._tmp = function () {
                ...
                }, n(v, m), v.prototype.split = function (e, t) {
                ...
                }, n(g, m), n(w, m), n(_, m), _.prototype.imulK = function (e) {
                    for (var t = 0, r = 0; r < e.length; r++) {
                    ...
                    if (y[e]) return y[e];
                    var t;
                    if ("k256" === e) t = new v; else if ("p224" === e) t = new g; else if ("p192" === e) t = new w; else {
                    ...
                    i(!n.isZero());
                    var f = new a(1).toRed(this), s = f.redNeg(), c = this.m.subn(1).iushrn(1), h = this.m.bitLength();
                    for (h = new a(2 * h * h).toRed(this); 0 !== this.pow(h, c).cmp(s);) h.redIAdd(s);
                    for (var d = this.pow(h, n), u = this.pow(e, n.addn(1).iushrn(1)), l = this.pow(e, n), p = o; 0 !== l.cmp(f);) {
                    ...
                    var n = r[0], o = 0, f = 0, s = t.bitLength() % 26;
                    for (0 === s && (s = 26), i = t.length - 1; i >= 0; i--) {
                        for (var c = t.words[i], h = s - 1; h >= 0; h--) {
                            var d = c >> h & 1;
                            n !== r[0] && (n = this.sqr(n)), 0 !== d || 0 !== o ? (o <<= 1, o |= d, (4 === ++f || 0 === i && 0 === h) && (n = this.mul(n, r[o]), f = 0, o = 0)) : f = 0
                        }
                        s = 26
                    }
                    return n
        ...
        (function (e) {
            ...
            function c(e, t, r, i) {
                ...
                return "undefined" != typeof ArrayBuffer && t instanceof ArrayBuffer ? function (e, t, r, i) {
                    ...
                    s.TYPED_ARRAY_SUPPORT ? (e = t).__proto__ = s.prototype : e = u(e, t);
                    return e
                    ...
                    if (t) {
                        if ("undefined" != typeof ArrayBuffer && t.buffer instanceof ArrayBuffer || "length" in t) return "number" != typeof t.length || (i = t.length) != i ? f(e, 0) : u(e, t);
            ...
            function d(e, t) {
                if (h(t), e = f(e, t < 0 ? 0 : 0 | l(t)), !s.TYPED_ARRAY_SUPPORT) for (var r = 0; r < t; ++r) e[r] = 0;
                return e
            }
            ...
            function y(e, t, r, i, n) {
                ...
                if ("number" == typeof t) return t &= 255, s.TYPED_ARRAY_SUPPORT && "function" == typeof Uint8Array.prototype.indexOf ? n ? Uint8Array.prototype.indexOf.call(e, t, r) : Uint8Array.prototype.lastIndexOf.call(e, t, r) : m(e, [t], r, i, n);
            ...
            function m(e, t, r, i, n) {
                ...
                } else for (r + s > f && (r = f - s), a = r; a >= 0; a--) {
                    for (var d = !0, u = 0; u < s; u++) if (c(e, a + u) !== c(t, u)) {
                        d = !1;
                        break
                    }
                    if (d) return a
            ...
            function A(e, t, r) {
                ...
                for (var i = [], n = t; n < r;) {
                    var a, o, f, s, c = e[n], h = null, d = c > 239 ? 4 : c > 223 ? 3 : c > 191 ? 2 : 1;
                    if (n + d <= r) switch (d) {
                        case 1:
                            c < 128 && (h = c);
                            break;
                        case 2:
                            128 == (192 & (a = e[n + 1])) && (s = (31 & c) << 6 | 63 & a) > 127 && (h = s);
                            break;
                        case 3:
                            a = e[n + 1], o = e[n + 2], 128 == (192 & a) && 128 == (192 & o) && (s = (15 & c) << 12 | (63 & a) << 6 | 63 & o) > 2047 && (s < 55296 || s > 57343) && (h = s);
                            break;
                        case 4:
                            a = e[n + 1], o = e[n + 2], f = e[n + 3], 128 == (192 & a) && 128 == (192 & o) && 128 == (192 & f) && (s = (15 & c) << 18 | (63 & a) << 12 | (63 & o) << 6 | 63 & f) > 65535 && s < 1114112 && (h = s)
                    }
                    null === h ? (h = 65533, d = 1) : h > 65535 && (h -= 65536, i.push(h >>> 10 & 1023 | 55296), h = 56320 | 1023 & h), i.push(h), n += d
                }
                return function (e) {
                    var t = e.length;
            ...
            t.Buffer = s, t.SlowBuffer = function (e) {
                ...
                return function (e, t, r, i) {
                    return h(t), t <= 0 ? f(e, t) : void 0 !== r ? "string" == typeof i ? f(e, t).fill(r, i) : f(e, t).fill(r) : f(e, t)
                }(null, e, t, r)
                ...
                for (var a = n - i, o = r - t, f = Math.min(a, o), c = this.slice(i, n), h = e.slice(t, r), d = 0; d < f; ++d) if (c[d] !== h[d]) {
                    a = c[d], o = h[d];
                    break
                }
            ...
            function L(e, t, r, i, a) {
                return a || U(e, 0, r, 4), n.write(e, t, r, i, 23, 4), r + 4
            }

            function N(e, t, r, i, a) {
                return a || U(e, 0, r, 8), n.write(e, t, r, i, 52, 8), r + 8
            }

            s.prototype.slice = function (e, t) {
                var r, i = this.length;
                if (e = ~~e, t = void 0 === t ? i : ~~t, e < 0 ? (e += i) < 0 && (e = 0) : e > i && (e = i), t < 0 ? (t += i) < 0 && (t = 0) : t > i && (t = i), t < e && (t = e), s.TYPED_ARRAY_SUPPORT) (r = this.subarray(e, t)).__proto__ = s.prototype; else {
                    var n = t - e;
                    r = new s(n, void 0);
                ...
                var a = 0, o = 1, f = 0;
                for (this[t] = 255 & e; ++a < r && (o *= 256);) e < 0 && 0 === f && 0 !== this[t + a - 1] && (f = 1), this[t + a] = (e / o >> 0) - f & 255;
                return t + r
                ...
                var a = r - 1, o = 1, f = 0;
                for (this[t + a] = 255 & e; --a >= 0 && (o *= 256);) e < 0 && 0 === f && 0 !== this[t + a + 1] && (f = 1), this[t + a] = (e / o >> 0) - f & 255;
                return t + r
                ...
                var n, a = i - r;
                if (this === e && r < t && t < i) for (n = a - 1; n >= 0; --n) e[n + t] = this[n + r]; else if (a < 1e3 || !s.TYPED_ARRAY_SUPPORT) for (n = 0; n < a; ++n) e[n + t] = this[n + r]; else Uint8Array.prototype.set.call(e, this.subarray(r, r + a), t);
                return a
                ...
                if (t >>>= 0, r = void 0 === r ? this.length : r >>> 0, e || (e = 0), "number" == typeof e) for (a = t; a < r; ++a) this[a] = e; else {
                    var o = s.isBuffer(e) ? e : z(new s(e, i).toString()), f = o.length;
        ...
        t.inherits = n, t.toArray = function (e, t) {
            ...
            for (var r = "", i = 0; i < e.length; i++) {
                var n = e[i];
                "little" === t && (n = a(n)), r += f(n.toString(16))
            }
            return r
        }, t.zero2 = o, t.zero8 = f, t.join32 = function (e, t, r, n) {
            var a = r - t;
            i(a % 4 == 0);
            for (var o = new Array(a / 4), f = 0, s = t; f < o.length; f++, s += 4) {
                var c;
                c = "big" === n ? e[s] << 24 | e[s + 1] << 16 | e[s + 2] << 8 | e[s + 3] : e[s + 3] << 24 | e[s + 2] << 16 | e[s + 1] << 8 | e[s], o[f] = c >>> 0
            }
            return o
            ...
            return t + i >>> 0
        }, t.sum64_4_hi = function (e, t, r, i, n, a, o, f) {
            var s = 0, c = t;
            return s += (c = c + i >>> 0) < t ? 1 : 0, s += (c = c + a >>> 0) < a ? 1 : 0, e + r + n + o + (s += (c = c + f >>> 0) < f ? 1 : 0) >>> 0
        }, t.sum64_4_lo = function (e, t, r, i, n, a, o, f) {
            return t + i + a + f >>> 0
        }, t.sum64_5_hi = function (e, t, r, i, n, a, o, f, s, c) {
            var h = 0, d = t;
            return h += (d = d + i >>> 0) < t ? 1 : 0, h += (d = d + a >>> 0) < a ? 1 : 0, h += (d = d + f >>> 0) < f ? 1 : 0, e + r + n + o + s + (h += (d = d + c >>> 0) < c ? 1 : 0) >>> 0
        }, t.sum64_5_lo = function (e, t, r, i, n, a, o, f, s, c) {
            return t + i + a + f + c >>> 0
        ...
        function u() {
            h && s && (h = !1, s.length ? c = s.concat(c) : d = -1, c.length && l())
        }
        ...
        n.nextTick = function (e) {
            ...
            c.push(new p(e, t)), 1 !== c.length || h || f(l)
        ...
        var i = r(1).Buffer, n = r(21).Transform, a = r(33).StringDecoder;
        ...
        r(0)(o, n), o.prototype.update = function (e, t, r) {
        ...
        var o = r(42), f = r(32);
        a.inherits(d, o);
        for (var s = n(f.prototype), c = 0; c < s.length; c++) {
            var h = s[c];
        ...
        function d(e) {
            ...
            o.call(this, e), f.call(this, e), e && !1 === e.readable && (this.readable = !1), e && !1 === e.writable && (this.writable = !1), this.allowHalfOpen = !0, e && !1 === e.allowHalfOpen && (this.allowHalfOpen = !1), this.once("end", u)
        }
        ...
        "use strict";
        (function (t, i) {
            var n = r(1).Buffer, a = t.crypto || t.msCrypto;
            a && a.getRandomValues ? e.exports = function (e, r) {
                if (e > 65536) throw new Error("requested too many random bytes");
                var o = new t.Uint8Array(e);
                e > 0 && a.getRandomValues(o);
                var f = n.from(o.buffer);
                if ("function" == typeof r) return i.nextTick(function () {
                    r(null, f)
                });
                return f
            } : e.exports = function () {
        ...
        n.prototype.update = function (e, t) {
            ...
            for (var r = this._block, n = this._blockSize, a = e.length, o = this._len, f = 0; f < a;) {
                for (var s = o % n, c = Math.min(a - f, n - s), h = 0; h < c; h++) r[s + h] = e[f + h];
                f += c, (o += c) % n == 0 && this._update(r)
            }
        ...
        "use strict";
        (function (t) {
            var i = r(0), n = r(28), a = r(29), o = r(34), f = r(9);
            ...
            }, i(c, f), c.prototype._update = function (e) {
                this._hash.update(e)
            }, c.prototype._final = function () {
                return this._hash.digest()
            }, e.exports = function (e) {
                return "md5" === (e = e.toLowerCase()) ? new s(n) : new c("rmd160" === e || "ripemd160" === e ? new a : o(e))
            }
        }).call(t, r(3).Buffer)
    }, function (e, t, r) {
        (function (e) {
        ...
        (function (t) {
            e.exports = function (e, r) {
                for (var i = Math.min(e.length, r.length), n = new t(i), a = 0; a < i; ++a) n[a] = e[a] ^ r[a];
                return n
            }
        }).call(t, r(3).Buffer)
    }, function (e, t, r) {
        ...
        r(0)(n, i), n.Readable = r(31), n.Writable = r(94), n.Duplex = r(95), n.Transform = r(96), n.PassThrough = r(97), n.Stream = n, n.prototype.pipe = function (e, t) {
            ...
            r.on("data", n), e.on("drain", a), e._isStdio || t && !1 === t.end || (r.on("end", f), r.on("close", s));
            var o = !1;
            ...
            function h() {
                r.removeListener("data", n), e.removeListener("drain", a), r.removeListener("end", f), r.removeListener("close", s), r.removeListener("error", c), e.removeListener("error", c), r.removeListener("end", h), r.removeListener("close", h), e.removeListener("close", h)
            }
        ...
        (function (t) {
            !t.version || 0 === t.version.indexOf("v0.") || 0 === t.version.indexOf("v1.") && 0 !== t.version.indexOf("v1.8.") ? e.exports = function (e, r, i, n) {
                ...
                switch (f) {
                    ...
                    default:
                        for (a = new Array(f - 1), o = 0; o < a.length;) a[o++] = arguments[o];
                        return t.nextTick(function () {
                            e.apply(null, a)
                        })
                }
        ...
        e.exports = function (e, t, r, a) {
            ...
            for (var o = r / 8, f = i.alloc(o), s = i.alloc(a || 0), c = i.alloc(0); o > 0 || a > 0;) {
                var h = new n;
                ...
                if (d < c.length && a > 0) {
                    var l = s.length - a, p = Math.min(a, c.length - d);
        ...
        function o(e, t, r, i, n) {
            for (var a, o, f, s, c = r[0], h = r[1], d = r[2], u = r[3], l = e[0] ^ t[0], p = e[1] ^ t[1], b = e[2] ^ t[2], y = e[3] ^ t[3], m = 4, v = 1; v < n; v++) a = c[l >>> 24] ^ h[p >>> 16 & 255] ^ d[b >>> 8 & 255] ^ u[255 & y] ^ t[m++], o = c[p >>> 24] ^ h[b >>> 16 & 255] ^ d[y >>> 8 & 255] ^ u[255 & l] ^ t[m++], f = c[b >>> 24] ^ h[y >>> 16 & 255] ^ d[l >>> 8 & 255] ^ u[255 & p] ^ t[m++], s = c[y >>> 24] ^ h[l >>> 16 & 255] ^ d[p >>> 8 & 255] ^ u[255 & b] ^ t[m++], l = a, p = o, b = f, y = s;
            return a = (i[l >>> 24] << 24 | i[p >>> 16 & 255] << 16 | i[b >>> 8 & 255] << 8 | i[255 & y]) ^ t[m++], o = (i[p >>> 24] << 24 | i[b >>> 16 & 255] << 16 | i[y >>> 8 & 255] << 8 | i[255 & l]) ^ t[m++], f = (i[b >>> 24] << 24 | i[y >>> 16 & 255] << 16 | i[l >>> 8 & 255] << 8 | i[255 & p]) ^ t[m++], s = (i[y >>> 24] << 24 | i[l >>> 16 & 255] << 16 | i[p >>> 8 & 255] << 8 | i[255 & b]) ^ t[m++], [a >>>= 0, o >>>= 0, f >>>= 0, s >>>= 0]
        }
        ...
        var f = [0, 1, 2, 4, 8, 16, 32, 64, 128, 27, 54], s = function () {
            ...
            for (var r = [], i = [], n = [[], [], [], []], a = [[], [], [], []], o = 0, f = 0, s = 0; s < 256; ++s) {
                ...
                var h = e[o], d = e[h], u = e[d], l = 257 * e[c] ^ 16843008 * c;
                n[0][o] = l << 24 | l >>> 8, n[1][o] = l << 16 | l >>> 16, n[2][o] = l << 8 | l >>> 24, n[3][o] = l, l = 16843009 * u ^ 65537 * d ^ 257 * h ^ 16843008 * o, a[0][c] = l << 24 | l >>> 8, a[1][c] = l << 16 | l >>> 16, a[2][c] = l << 8 | l >>> 24, a[3][c] = l, 0 === o ? o = f = 1 : (o = h ^ e[e[e[u ^ h]]], f ^= e[e[f]])
            }
        ...
        c.blockSize = 16, c.keySize = 32, c.prototype.blockSize = c.blockSize, c.prototype.keySize = c.keySize, c.prototype._reset = function () {
            ...
            for (a = t; a < i; a++) {
                var o = n[a - 1];
                a % t == 0 ? (o = o << 8 | o >>> 24, o = s.SBOX[o >>> 24] << 24 | s.SBOX[o >>> 16 & 255] << 16 | s.SBOX[o >>> 8 & 255] << 8 | s.SBOX[255 & o], o ^= f[a / t | 0] << 24) : t > 6 && a % t == 4 && (o = s.SBOX[o >>> 24] << 24 | s.SBOX[o >>> 16 & 255] << 16 | s.SBOX[o >>> 8 & 255] << 8 | s.SBOX[255 & o]), n[a] = n[a - t] ^ o
            }
            for (var c = [], h = 0; h < i; h++) {
                var d = i - h, u = n[d - (h % 4 ? 0 : 4)];
                c[h] = h < 4 || d <= 4 ? u : s.INV_SUB_MIX[0][s.SBOX[u >>> 24]] ^ s.INV_SUB_MIX[1][s.SBOX[u >>> 16 & 255]] ^ s.INV_SUB_MIX[2][s.SBOX[u >>> 8 & 255]] ^ s.INV_SUB_MIX[3][s.SBOX[255 & u]]
            }
                    ...
                    case"ENCRYPTED PRIVATE KEY":
                        u = function (e, r) {
                            var i = e.algorithm.decrypt.kde.kdeparams.salt,
                                ...
                                s = n[e.algorithm.decrypt.cipher.algo.join(".")], c = e.algorithm.decrypt.cipher.iv,
                                h = e.subjectPrivateKey, d = parseInt(s.split("-")[1], 10) / 8,
                                u = f.pbkdf2Sync(r, i, a, d), l = o.createDecipheriv(s, u, c), p = [];
                            return p.push(l.update(h)), p.push(l.final()), t.concat(p)
                        }(u = i.EncryptedPrivateKey.decode(u, "der"), r);
                    case"PRIVATE KEY":
                        switch (s = (c = i.PrivateKey.decode(u, "der")).algorithm.algorithm.join(".")) {
                            case"1.2.840.113549.1.1.1":
        ...
        "use strict";
        const i = r(2), n = r(11), a = r(74), o = r(10);

        class f extends o.Scalar {
            constructor(e, t) {
                super(), this.ref = {
            ...
            clone() {
                return new f(this.ref.curve, this.ref.red).setBytes(new Uint8Array(this.ref.arr.fromRed().toArray("be")))
            }
            ...
            pick(e) {
                e = e || n.randomBytes;
                let t = a.int(this.ref.curve.curve.n, e);
        ...
        function n(e, t) {
            ...
            for (var r = 1732584193, i = -271733879, n = -1732584194, a = 271733878, d = 0; d < e.length; d += 16) {
                var u = r, l = i, p = n, b = a;
                i = c(i = c(i = c(i = c(i = s(i = s(i = s(i = s(i = f(i = f(i = f(i = f(i = o(i = o(i = o(i = o(i, n = o(n, a = o(a, r = o(r, i, n, a, e[d + 0], 7, -680876936), i, n, e[d + 1], 12, -389564586), r, i, e[d + 2], 17, 606105819), a, r, e[d + 3], 22, -1044525330), n = o(n, a = o(a, r = o(r, i, n, a, e[d + 4], 7, -176418897), i, n, e[d + 5], 12, 1200080426), r, i, e[d + 6], 17, -1473231341), a, r, e[d + 7], 22, -45705983), n = o(n, a = o(a, r = o(r, i, n, a, e[d + 8], 7, 1770035416), i, n, e[d + 9], 12, -1958414417), r, i, e[d + 10], 17, -42063), a, r, e[d + 11], 22, -1990404162), n = o(n, a = o(a, r = o(r, i, n, a, e[d + 12], 7, 1804603682), i, n, e[d + 13], 12, -40341101), r, i, e[d + 14], 17, -1502002290), a, r, e[d + 15], 22, 1236535329), n = f(n, a = f(a, r = f(r, i, n, a, e[d + 1], 5, -165796510), i, n, e[d + 6], 9, -1069501632), r, i, e[d + 11], 14, 643717713), a, r, e[d + 0], 20, -373897302), n = f(n, a = f(a, r = f(r, i, n, a, e[d + 5], 5, -701558691), i, n, e[d + 10], 9, 38016083), r, i, e[d + 15], 14, -660478335), a, r, e[d + 4], 20, -405537848), n = f(n, a = f(a, r = f(r, i, n, a, e[d + 9], 5, 568446438), i, n, e[d + 14], 9, -1019803690), r, i, e[d + 3], 14, -187363961), a, r, e[d + 8], 20, 1163531501), n = f(n, a = f(a, r = f(r, i, n, a, e[d + 13], 5, -1444681467), i, n, e[d + 2], 9, -51403784), r, i, e[d + 7], 14, 1735328473), a, r, e[d + 12], 20, -1926607734), n = s(n, a = s(a, r = s(r, i, n, a, e[d + 5], 4, -378558), i, n, e[d + 8], 11, -2022574463), r, i, e[d + 11], 16, 1839030562), a, r, e[d + 14], 23, -35309556), n = s(n, a = s(a, r = s(r, i, n, a, e[d + 1], 4, -1530992060), i, n, e[d + 4], 11, 1272893353), r, i, e[d + 7], 16, -155497632), a, r, e[d + 10], 23, -1094730640), n = s(n, a = s(a, r = s(r, i, n, a, e[d + 13], 4, 681279174), i, n, e[d + 0], 11, -358537222), r, i, e[d + 3], 16, -722521979), a, r, e[d + 6], 23, 76029189), n = s(n, a = s(a, r = s(r, i, n, a, e[d + 9], 4, -640364487), i, n, e[d + 12], 11, -421815835), r, i, e[d + 15], 16, 530742520), a, r, e[d + 2], 23, -995338651), n = c(n, a = c(a, r = c(r, i, n, a, e[d + 0], 6, -198630844), i, n, e[d + 7], 10, 1126891415), r, i, e[d + 14], 15, -1416354905), a, r, e[d + 5], 21, -57434055), n = c(n, a = c(a, r = c(r, i, n, a, e[d + 12], 6, 1700485571), i, n, e[d + 3], 10, -1894986606), r, i, e[d + 10], 15, -1051523), a, r, e[d + 1], 21, -2054922799), n = c(n, a = c(a, r = c(r, i, n, a, e[d + 8], 6, 1873313359), i, n, e[d + 15], 10, -30611744), r, i, e[d + 6], 15, -1560198380), a, r, e[d + 13], 21, 1309151649), n = c(n, a = c(a, r = c(r, i, n, a, e[d + 4], 6, -145523070), i, n, e[d + 11], 10, -1120210379), r, i, e[d + 2], 15, 718787259), a, r, e[d + 9], 21, -343485551), r = h(r, u), i = h(i, l), n = h(n, p), a = h(a, b)
            }
            return [r, i, n, a]
        }

        function a(e, t, r, i, n, a) {
            return h((o = h(h(t, e), h(i, a))) << (f = n) | o >>> 32 - f, r);
            var o, f
        }

        function o(e, t, r, i, n, o, f) {
            return a(t & r | ~t & i, e, t, n, o, f)
        }

        function f(e, t, r, i, n, o, f) {
            return a(t & i | r & ~i, e, t, n, o, f)
        }

        function s(e, t, r, i, n, o, f) {
            return a(t ^ r ^ i, e, t, n, o, f)
        }

        function c(e, t, r, i, n, o, f) {
            return a(r ^ (t | ~i), e, t, n, o, f)
        }
        ...
        (function (t) {
            ...
            function f(e, t, r, i, n, a, f, s) {
                return o(e + (t ^ r ^ i) + a + f | 0, s) + n | 0
            }

            function s(e, t, r, i, n, a, f, s) {
                return o(e + (t & r | ~t & i) + a + f | 0, s) + n | 0
            }

            function c(e, t, r, i, n, a, f, s) {
                return o(e + ((t | ~r) ^ i) + a + f | 0, s) + n | 0
            }

            function h(e, t, r, i, n, a, f, s) {
                return o(e + (t & i | r & ~i) + a + f | 0, s) + n | 0
            }

            function d(e, t, r, i, n, a, f, s) {
                return o(e + (t ^ (r | ~i)) + a + f | 0, s) + n | 0
            }

            i(a, n), a.prototype._update = function () {
                for (var e = new Array(16), t = 0; t < 16; ++t) e[t] = this._block.readInt32LE(4 * t);
                var r = this._a, i = this._b, n = this._c, a = this._d, u = this._e;
                u = f(u, r = f(r, i, n, a, u, e[0], 0, 11), i, n = o(n, 10), a, e[1], 0, 14), i = f(i = o(i, 10), n = f(n, a = f(a, u, r, i, n, e[2], 0, 15), u, r = o(r, 10), i, e[3], 0, 12), a, u = o(u, 10), r, e[4], 0, 5), a = f(a = o(a, 10), u = f(u, r = f(r, i, n, a, u, e[5], 0, 8), i, n = o(n, 10), a, e[6], 0, 7), r, i = o(i, 10), n, e[7], 0, 9), r = f(r = o(r, 10), i = f(i, n = f(n, a, u, r, i, e[8], 0, 11), a, u = o(u, 10), r, e[9], 0, 13), n, a = o(a, 10), u, e[10], 0, 14), n = f(n = o(n, 10), a = f(a, u = f(u, r, i, n, a, e[11], 0, 15), r, i = o(i, 10), n, e[12], 0, 6), u, r = o(r, 10), i, e[13], 0, 7), u = s(u = o(u, 10), r = f(r, i = f(i, n, a, u, r, e[14], 0, 9), n, a = o(a, 10), u, e[15], 0, 8), i, n = o(n, 10), a, e[7], 1518500249, 7), i = s(i = o(i, 10), n = s(n, a = s(a, u, r, i, n, e[4], 1518500249, 6), u, r = o(r, 10), i, e[13], 1518500249, 8), a, u = o(u, 10), r, e[1], 1518500249, 13), a = s(a = o(a, 10), u = s(u, r = s(r, i, n, a, u, e[10], 1518500249, 11), i, n = o(n, 10), a, e[6], 1518500249, 9), r, i = o(i, 10), n, e[15], 1518500249, 7), r = s(r = o(r, 10), i = s(i, n = s(n, a, u, r, i, e[3], 1518500249, 15), a, u = o(u, 10), r, e[12], 1518500249, 7), n, a = o(a, 10), u, e[0], 1518500249, 12), n = s(n = o(n, 10), a = s(a, u = s(u, r, i, n, a, e[9], 1518500249, 15), r, i = o(i, 10), n, e[5], 1518500249, 9), u, r = o(r, 10), i, e[2], 1518500249, 11), u = s(u = o(u, 10), r = s(r, i = s(i, n, a, u, r, e[14], 1518500249, 7), n, a = o(a, 10), u, e[11], 1518500249, 13), i, n = o(n, 10), a, e[8], 1518500249, 12), i = c(i = o(i, 10), n = c(n, a = c(a, u, r, i, n, e[3], 1859775393, 11), u, r = o(r, 10), i, e[10], 1859775393, 13), a, u = o(u, 10), r, e[14], 1859775393, 6), a = c(a = o(a, 10), u = c(u, r = c(r, i, n, a, u, e[4], 1859775393, 7), i, n = o(n, 10), a, e[9], 1859775393, 14), r, i = o(i, 10), n, e[15], 1859775393, 9), r = c(r = o(r, 10), i = c(i, n = c(n, a, u, r, i, e[8], 1859775393, 13), a, u = o(u, 10), r, e[1], 1859775393, 15), n, a = o(a, 10), u, e[2], 1859775393, 14), n = c(n = o(n, 10), a = c(a, u = c(u, r, i, n, a, e[7], 1859775393, 8), r, i = o(i, 10), n, e[0], 1859775393, 13), u, r = o(r, 10), i, e[6], 1859775393, 6), u = c(u = o(u, 10), r = c(r, i = c(i, n, a, u, r, e[13], 1859775393, 5), n, a = o(a, 10), u, e[11], 1859775393, 12), i, n = o(n, 10), a, e[5], 1859775393, 7), i = h(i = o(i, 10), n = h(n, a = c(a, u, r, i, n, e[12], 1859775393, 5), u, r = o(r, 10), i, e[1], 2400959708, 11), a, u = o(u, 10), r, e[9], 2400959708, 12), a = h(a = o(a, 10), u = h(u, r = h(r, i, n, a, u, e[11], 2400959708, 14), i, n = o(n, 10), a, e[10], 2400959708, 15), r, i = o(i, 10), n, e[0], 2400959708, 14), r = h(r = o(r, 10), i = h(i, n = h(n, a, u, r, i, e[8], 2400959708, 15), a, u = o(u, 10), r, e[12], 2400959708, 9), n, a = o(a, 10), u, e[4], 2400959708, 8), n = h(n = o(n, 10), a = h(a, u = h(u, r, i, n, a, e[13], 2400959708, 9), r, i = o(i, 10), n, e[3], 2400959708, 14), u, r = o(r, 10), i, e[7], 2400959708, 5), u = h(u = o(u, 10), r = h(r, i = h(i, n, a, u, r, e[15], 2400959708, 6), n, a = o(a, 10), u, e[14], 2400959708, 8), i, n = o(n, 10), a, e[5], 2400959708, 6), i = d(i = o(i, 10), n = h(n, a = h(a, u, r, i, n, e[6], 2400959708, 5), u, r = o(r, 10), i, e[2], 2400959708, 12), a, u = o(u, 10), r, e[4], 2840853838, 9), a = d(a = o(a, 10), u = d(u, r = d(r, i, n, a, u, e[0], 2840853838, 15), i, n = o(n, 10), a, e[5], 2840853838, 5), r, i = o(i, 10), n, e[9], 2840853838, 11), r = d(r = o(r, 10), i = d(i, n = d(n, a, u, r, i, e[7], 2840853838, 6), a, u = o(u, 10), r, e[12], 2840853838, 8), n, a = o(a, 10), u, e[2], 2840853838, 13), n = d(n = o(n, 10), a = d(a, u = d(u, r, i, n, a, e[10], 2840853838, 12), r, i = o(i, 10), n, e[14], 2840853838, 5), u, r = o(r, 10), i, e[1], 2840853838, 12), u = d(u = o(u, 10), r = d(r, i = d(i, n, a, u, r, e[3], 2840853838, 13), n, a = o(a, 10), u, e[8], 2840853838, 14), i, n = o(n, 10), a, e[11], 2840853838, 11), i = d(i = o(i, 10), n = d(n, a = d(a, u, r, i, n, e[6], 2840853838, 8), u, r = o(r, 10), i, e[15], 2840853838, 5), a, u = o(u, 10), r, e[13], 2840853838, 6), a = o(a, 10);
                var l = this._a, p = this._b, b = this._c, y = this._d, m = this._e;
                m = d(m, l = d(l, p, b, y, m, e[5], 1352829926, 8), p, b = o(b, 10), y, e[14], 1352829926, 9), p = d(p = o(p, 10), b = d(b, y = d(y, m, l, p, b, e[7], 1352829926, 9), m, l = o(l, 10), p, e[0], 1352829926, 11), y, m = o(m, 10), l, e[9], 1352829926, 13), y = d(y = o(y, 10), m = d(m, l = d(l, p, b, y, m, e[2], 1352829926, 15), p, b = o(b, 10), y, e[11], 1352829926, 15), l, p = o(p, 10), b, e[4], 1352829926, 5), l = d(l = o(l, 10), p = d(p, b = d(b, y, m, l, p, e[13], 1352829926, 7), y, m = o(m, 10), l, e[6], 1352829926, 7), b, y = o(y, 10), m, e[15], 1352829926, 8), b = d(b = o(b, 10), y = d(y, m = d(m, l, p, b, y, e[8], 1352829926, 11), l, p = o(p, 10), b, e[1], 1352829926, 14), m, l = o(l, 10), p, e[10], 1352829926, 14), m = h(m = o(m, 10), l = d(l, p = d(p, b, y, m, l, e[3], 1352829926, 12), b, y = o(y, 10), m, e[12], 1352829926, 6), p, b = o(b, 10), y, e[6], 1548603684, 9), p = h(p = o(p, 10), b = h(b, y = h(y, m, l, p, b, e[11], 1548603684, 13), m, l = o(l, 10), p, e[3], 1548603684, 15), y, m = o(m, 10), l, e[7], 1548603684, 7), y = h(y = o(y, 10), m = h(m, l = h(l, p, b, y, m, e[0], 1548603684, 12), p, b = o(b, 10), y, e[13], 1548603684, 8), l, p = o(p, 10), b, e[5], 1548603684, 9), l = h(l = o(l, 10), p = h(p, b = h(b, y, m, l, p, e[10], 1548603684, 11), y, m = o(m, 10), l, e[14], 1548603684, 7), b, y = o(y, 10), m, e[15], 1548603684, 7), b = h(b = o(b, 10), y = h(y, m = h(m, l, p, b, y, e[8], 1548603684, 12), l, p = o(p, 10), b, e[12], 1548603684, 7), m, l = o(l, 10), p, e[4], 1548603684, 6), m = h(m = o(m, 10), l = h(l, p = h(p, b, y, m, l, e[9], 1548603684, 15), b, y = o(y, 10), m, e[1], 1548603684, 13), p, b = o(b, 10), y, e[2], 1548603684, 11), p = c(p = o(p, 10), b = c(b, y = c(y, m, l, p, b, e[15], 1836072691, 9), m, l = o(l, 10), p, e[5], 1836072691, 7), y, m = o(m, 10), l, e[1], 1836072691, 15), y = c(y = o(y, 10), m = c(m, l = c(l, p, b, y, m, e[3], 1836072691, 11), p, b = o(b, 10), y, e[7], 1836072691, 8), l, p = o(p, 10), b, e[14], 1836072691, 6), l = c(l = o(l, 10), p = c(p, b = c(b, y, m, l, p, e[6], 1836072691, 6), y, m = o(m, 10), l, e[9], 1836072691, 14), b, y = o(y, 10), m, e[11], 1836072691, 12), b = c(b = o(b, 10), y = c(y, m = c(m, l, p, b, y, e[8], 1836072691, 13), l, p = o(p, 10), b, e[12], 1836072691, 5), m, l = o(l, 10), p, e[2], 1836072691, 14), m = c(m = o(m, 10), l = c(l, p = c(p, b, y, m, l, e[10], 1836072691, 13), b, y = o(y, 10), m, e[0], 1836072691, 13), p, b = o(b, 10), y, e[4], 1836072691, 7), p = s(p = o(p, 10), b = s(b, y = c(y, m, l, p, b, e[13], 1836072691, 5), m, l = o(l, 10), p, e[8], 2053994217, 15), y, m = o(m, 10), l, e[6], 2053994217, 5), y = s(y = o(y, 10), m = s(m, l = s(l, p, b, y, m, e[4], 2053994217, 8), p, b = o(b, 10), y, e[1], 2053994217, 11), l, p = o(p, 10), b, e[3], 2053994217, 14), l = s(l = o(l, 10), p = s(p, b = s(b, y, m, l, p, e[11], 2053994217, 14), y, m = o(m, 10), l, e[15], 2053994217, 6), b, y = o(y, 10), m, e[0], 2053994217, 14), b = s(b = o(b, 10), y = s(y, m = s(m, l, p, b, y, e[5], 2053994217, 6), l, p = o(p, 10), b, e[12], 2053994217, 9), m, l = o(l, 10), p, e[2], 2053994217, 12), m = s(m = o(m, 10), l = s(l, p = s(p, b, y, m, l, e[13], 2053994217, 9), b, y = o(y, 10), m, e[9], 2053994217, 12), p, b = o(b, 10), y, e[7], 2053994217, 5), p = f(p = o(p, 10), b = s(b, y = s(y, m, l, p, b, e[10], 2053994217, 15), m, l = o(l, 10), p, e[14], 2053994217, 8), y, m = o(m, 10), l, e[12], 0, 8), y = f(y = o(y, 10), m = f(m, l = f(l, p, b, y, m, e[15], 0, 5), p, b = o(b, 10), y, e[10], 0, 12), l, p = o(p, 10), b, e[4], 0, 9), l = f(l = o(l, 10), p = f(p, b = f(b, y, m, l, p, e[1], 0, 12), y, m = o(m, 10), l, e[5], 0, 5), b, y = o(y, 10), m, e[8], 0, 14), b = f(b = o(b, 10), y = f(y, m = f(m, l, p, b, y, e[7], 0, 6), l, p = o(p, 10), b, e[6], 0, 8), m, l = o(l, 10), p, e[2], 0, 13), m = f(m = o(m, 10), l = f(l, p = f(p, b, y, m, l, e[13], 0, 6), b, y = o(y, 10), m, e[14], 0, 5), p, b = o(b, 10), y, e[0], 0, 15), p = f(p = o(p, 10), b = f(b, y = f(y, m, l, p, b, e[3], 0, 13), m, l = o(l, 10), p, e[9], 0, 11), y, m = o(m, 10), l, e[11], 0, 11), y = o(y, 10);
                var v = this._b + n + y | 0;
                this._b = this._c + a + m | 0, this._c = this._d + u + l | 0, this._d = this._e + r + p | 0, this._e = this._a + i + b | 0, this._a = v
        ...
        e.exports = r, r.EventEmitter = r, r.prototype._events = void 0, r.prototype._maxListeners = void 0, r.defaultMaxListeners = 10, r.prototype.setMaxListeners = function (e) {
            ...
            } else if (n(r)) for (f = Array.prototype.slice.call(arguments, 1), o = (c = r.slice()).length, s = 0; s < o; s++) c[s].apply(this, f);
            return !0
            ...
            if (o = (r = this._events[e]).length, a = -1, r === t || i(r.listener) && r.listener === t) delete this._events[e], this._events.removeListener && this.emit("removeListener", e, t); else if (n(r)) {
                for (f = o; f-- > 0;) if (r[f] === t || r[f].listener && r[f].listener === t) {
                    a = f;
                    break
                }
                if (a < 0) return this;
        ...
        (function (t, i, n) {
            ...
            e.exports = v;
            var f, s = !t.browser && ["v0.10", "v0.9."].indexOf(t.version.slice(0, 5)) > -1 ? i : a;
            v.WritableState = m;
            var c = r(16);
            c.inherits = r(0);
            var h = {deprecate: r(92)}, d = r(43), u = r(1).Buffer, l = n.Uint8Array || function () {
            };
            var p, b = r(44);
            ...
            function m(e, t) {
                f = f || r(12), e = e || {}, this.objectMode = !!e.objectMode, t instanceof f && (this.objectMode = this.objectMode || !!e.writableObjectMode);
                ...
                this.decodeStrings = !c, this.defaultEncoding = e.defaultEncoding || "utf8", this.length = 0, this.writing = !1, this.corked = 0, this.sync = !0, this.bufferProcessing = !1, this.onwrite = function (e) {
                    !function (e, t) {
                        ...
                        if (function (e) {
                            ...
                            --t.pendingcb, r ? (a(n, i), a(E, e, t), e._writableState.errorEmitted = !0, e.emit("error", i)) : (n(i), e._writableState.errorEmitted = !0, e.emit("error", i), E(e, t))
                        }(e, r, i, t, n); else {
                            var o = S(r);
                            o || r.corked || r.bufferProcessing || !r.bufferedRequest || _(e, r), i ? s(w, e, r, o, n) : w(e, r, o, n)
                        }
                    }(t, e)
            ...
            function v(e) {
                if (f = f || r(12), !(p.call(v, this) || this instanceof f)) return new v(e);
            ...
            function _(e, t) {
                ...
                if (e._writev && r && r.next) {
                    ...
                    a.entry = r;
                    for (var f = 0, s = !0; r;) n[f] = r, r.isBuf || (s = !1), r = r.next, f += 1;
                    n.allBuffers = s, g(e, t, !0, t.length, n, "", a.finish), t.pendingcb++, t.lastBufferedRequest = null, a.next ? (t.corkedRequestsFree = a.next, a.next = null) : t.corkedRequestsFree = new o(t)
                } else {
                    for (; r;) {
                        var c = r.chunk, h = r.encoding, d = r.callback;
                        if (g(e, t, !1, t.objectMode ? 1 : c.length, c, h, d), r = r.next, t.writing) break
                    }
            ...
            function E(e, t) {
                ...
                return r && (!function (e, t) {
                    t.prefinished || t.finalCalled || ("function" == typeof e._final ? (t.pendingcb++, t.finalCalled = !0, a(M, e, t)) : (t.prefinished = !0, e.emit("prefinish")))
                }(e, t), 0 === t.pendingcb && (t.finished = !0, e.emit("finish"))), r
            }

            c.inherits(v, d), m.prototype.getBuffer = function () {
                ...
                value: function (e) {
                    return !!p.call(this, e) || e && e._writableState instanceof m
                }
            })) : p = function (e) {
                ...
                var i, n = this._writableState, o = !1, f = (i = e, (u.isBuffer(i) || i instanceof l) && !n.objectMode);
                return f && !u.isBuffer(e) && (e = function (e) {
                    return u.from(e)
                }(e)), "function" == typeof t && (r = t, t = null), f ? t = "buffer" : t || (t = n.defaultEncoding), "function" != typeof r && (r = y), n.ended ? function (e, t) {
                    var r = new Error("write after end");
                    e.emit("error", r), a(t, r)
                }(this, r) : (f || function (e, t, r, i) {
                    var n = !0, o = !1;
                    return null === r ? o = new TypeError("May not write null values to stream") : "string" == typeof r || void 0 === r || t.objectMode || (o = new TypeError("Invalid non-string/buffer chunk")), o && (e.emit("error", o), a(i, o), n = !1), n
                }(this, n, e, r)) && (n.pendingcb++, o = function (e, t, r, i, n, a) {
                    if (!r) {
                ...
                "function" == typeof e ? (r = e, e = null, t = null) : "function" == typeof t && (r = t, t = null), null !== e && void 0 !== e && this.write(e, t), i.corked && (i.corked = 1, this.uncork()), i.ending || i.finished || function (e, t, r) {
                    t.ending = !0, E(e, t), r && (t.finished ? a(r) : e.once("finish", r));
        ...
        (function (t) {
            ...
            function a(e, r) {
                var n = function (e) {
                    ...
                    }(r), a = r.modulus.byteLength(), f = (i.mont(r.modulus), new i(e).mul(n.blinder).umod(r.modulus)),
                    s = f.toRed(i.mont(r.prime1)), c = f.toRed(i.mont(r.prime2)), h = r.coefficient, d = r.prime1,
                    u = r.prime2, l = s.redPow(r.exponent1), p = c.redPow(r.exponent2);
                l = l.fromRed(), p = p.fromRed();
                var b = l.isub(p).imul(h).umod(d);
                return b.imul(u), p.iadd(b), new t(p.imul(n.unblinder).umod(r.modulus).toArray(!1, a))
            }
        ...
        class f extends o.Scalar {
            ...
            clone() {
                return new f(this.ref.curve, this.ref.red).setBytes(new Uint8Array(this.ref.arr.fromRed().toArray("le")))
            }
            ...
            pick(e) {
                return e = e || n.randomBytes, bytes = a.int(this.ref.curve.curve.n, e), this.ref.arr = new i(bytes, 16).toRed(this.ref.red), this
            }
        ...
        (function (t, i) {
            ...
            }, s = r(43), c = r(1).Buffer, h = t.Uint8Array || function () {
            };
            var d = r(16);
            d.inherits = r(0);
            var u = r(88), l = void 0;
            ...
            function v(e, t) {
                a = a || r(12), e = e || {}, this.objectMode = !!e.objectMode, t instanceof a && (this.objectMode = this.objectMode || !!e.readableObjectMode);
                var i = e.highWaterMark, n = this.objectMode ? 16 : 16384;
            ...
            function g(e) {
                if (a = a || r(12), !(this instanceof g)) return new g(e);
            ...
            function w(e, t, r, i, n) {
                ...
                null === t ? (o.reading = !1, function (e, t) {
                    ...
                    t.ended = !0, E(e)
                }(e, o)) : (n || (a = function (e, t) {
                    var r;
                    i = t, c.isBuffer(i) || i instanceof h || "string" == typeof t || void 0 === t || e.objectMode || (r = new TypeError("Invalid non-string/buffer chunk"));
                    var i;
                    return r
                    ...
                    return c.from(e)
                }(t)), i ? o.endEmitted ? e.emit("error", new Error("stream.unshift() after end event")) : _(e, o, t, !0) : o.ended ? e.emit("error", new Error("stream.push() after EOF")) : (o.reading = !1, o.decoder && !r ? (t = o.decoder.write(t), o.objectMode || 0 !== t.length ? _(e, o, t, !1) : k(e, o)) : _(e, o, t, !1))) : i || (o.reading = !1));
                return function (e) {
            ...
            function _(e, t, r, i) {
                t.flowing && 0 === t.length && !t.sync ? (e.emit("data", r), e.read(0)) : (t.length += t.objectMode ? 1 : r.length, i ? t.buffer.unshift(r) : t.buffer.push(r), t.needReadable && E(e)), k(e, t)
            }
            ...
            function E(e) {
                ...
                t.needReadable = !1, t.emittedReadable || (l("emitReadable", t.flowing), t.emittedReadable = !0, t.sync ? n(A, e) : A(e))
            }
            ...
            function k(e, t) {
                t.readingMore || (t.readingMore = !0, n(x, e, t))
            }
            ...
            function I(e, t) {
                t.reading || (l("resume read 0"), e.read(0)), t.resumeScheduled = !1, t.awaitDrain = 0, e.emit("resume"), R(e), t.flowing && !t.reading && e.read(0)
            }
            ...
            g.prototype.read = function (e) {
                ...
                if (0 !== e && (t.emittedReadable = !1), 0 === e && t.needReadable && (t.length >= t.highWaterMark || t.ended)) return l("read: emitReadable", t.length, t.ended), 0 === t.length && t.ended ? T(this) : E(this), null;
                if (0 === (e = M(e, t)) && t.ended) return 0 === t.length && T(this), null;
                ...
                var s = (!t || !1 !== t.end) && e !== i.stdout && e !== i.stderr ? h : g;

                function c(t, i) {
                    l("onunpipe"), t === r && i && !1 === i.hasUnpiped && (i.hasUnpiped = !0, l("cleanup"), e.removeListener("close", m), e.removeListener("finish", v), e.removeListener("drain", d), e.removeListener("error", y), e.removeListener("unpipe", c), r.removeListener("end", h), r.removeListener("end", g), r.removeListener("data", b), u = !0, !a.awaitDrain || e._writableState && !e._writableState.needDrain || d())
                }
                ...
                a.endEmitted ? n(s) : r.once("end", s), e.on("unpipe", c);
                var d = function (e) {
                    return function () {
                        var t = e._readableState;
                        l("pipeOnDrain", t.awaitDrain), t.awaitDrain && t.awaitDrain--, 0 === t.awaitDrain && f(e, "data") && (t.flowing = !0, R(e))
                    }
                }(r);
                e.on("drain", d);
                var u = !1;
                ...
                function b(t) {
                    l("ondata"), p = !1, !1 !== e.write(t) || p || ((1 === a.pipesCount && a.pipes === e || a.pipesCount > 1 && -1 !== j(a.pipes, e)) && !u && (l("false write response, pause", r._readableState.awaitDrain), r._readableState.awaitDrain++, p = !0), r.pause())
                }
                ...
                }(e, "error", y), e.once("close", m), e.once("finish", v), e.emit("pipe", r), a.flowing || (l("pipe resume"), r.resume()), e
                ...
                if ("data" === e) !1 !== this._readableState.flowing && this.resume(); else if ("readable" === e) {
                    ...
                    i.endEmitted || i.readableListening || (i.readableListening = i.needReadable = !0, i.emittedReadable = !1, i.reading ? i.length && E(this) : n(B, this))
                }
                return r
                ...
                return e.flowing || (l("resume"), e.flowing = !0, function (e, t) {
                    t.resumeScheduled || (t.resumeScheduled = !0, n(I, e, t))
                }(this, e)), this
                ...
                for (var n in e.on("end", function () {
                    ...
                    (l("wrapped data"), t.decoder && (n = t.decoder.write(n)), !t.objectMode || null !== n && void 0 !== n) && ((t.objectMode || n && n.length) && (i.push(n) || (r = !0, e.pause())))
                }), e) void 0 === this[n] && "function" == typeof e[n] && (this[n] = function (t) {
                    return function () {
                        return e[t].apply(e, arguments)
                    }
                }(n));
                for (var a = 0; a < m.length; a++) e.on(m[a], i.emit.bind(i, m[a]));
        ...
        e.exports = {
            destroy: function (e, t) {
                ...
                a || o ? t ? t(e) : !e || this._writableState && this._writableState.errorEmitted || i(n, this, e) : (this._readableState && (this._readableState.destroyed = !0), this._writableState && (this._writableState.destroyed = !0), this._destroy(e || null, function (e) {
        ...
        function a(e) {
            this.afterTransform = function (t, r) {
                return function (e, t, r) {
                    ...
                    i.writechunk = null, i.writecb = null, null !== r && void 0 !== r && e.push(r);
                    n(t);
        ...
        function o(e) {
            ...
            i.call(this, e), this._transformState = new a(this);
            var t = this;
        ...
        i(s, n), s.prototype.init = function () {
            ...
            for (var t, r = this._w, i = 0 | this._a, n = 0 | this._b, a = 0 | this._c, f = 0 | this._d, s = 0 | this._e, p = 0 | this._f, b = 0 | this._g, y = 0 | this._h, m = 0; m < 16; ++m) r[m] = e.readInt32BE(4 * m);
            for (; m < 64; ++m) r[m] = 0 | (((t = r[m - 2]) >>> 17 | t << 15) ^ (t >>> 19 | t << 13) ^ t >>> 10) + r[m - 7] + l(r[m - 15]) + r[m - 16];
            for (var v = 0; v < 64; ++v) {
                var g = y + u(s) + c(s, p, b) + o[v] + r[v] | 0, w = d(i) + h(i, n, a) | 0;
                y = b, b = p, p = s, s = f + g | 0, f = a, a = n, n = i, i = g + w | 0
            }
            this._a = i + this._a | 0, this._b = n + this._b | 0, this._c = a + this._c | 0, this._d = f + this._d | 0, this._e = s + this._e | 0, this._f = p + this._f | 0, this._g = b + this._g | 0, this._h = y + this._h | 0
        ...
        i(s, n), s.prototype.init = function () {
            ...
            for (var t = this._w, r = 0 | this._ah, i = 0 | this._bh, n = 0 | this._ch, a = 0 | this._dh, f = 0 | this._eh, s = 0 | this._fh, v = 0 | this._gh, g = 0 | this._hh, w = 0 | this._al, _ = 0 | this._bl, S = 0 | this._cl, M = 0 | this._dl, E = 0 | this._el, A = 0 | this._fl, k = 0 | this._gl, x = 0 | this._hl, B = 0; B < 32; B += 2) t[B] = e.readInt32BE(4 * B), t[B + 1] = e.readInt32BE(4 * B + 4);
            for (; B < 160; B += 2) {
                var I = t[B - 30], R = t[B - 30 + 1], P = l(I, R), T = p(R, I), C = b(I = t[B - 4], R = t[B - 4 + 1]),
                    j = y(R, I), U = t[B - 14], L = t[B - 14 + 1], N = t[B - 32], D = t[B - 32 + 1], O = T + L | 0,
                    z = P + U + m(O, T) | 0;
                z = (z = z + C + m(O = O + j | 0, j) | 0) + N + m(O = O + D | 0, D) | 0, t[B] = z, t[B + 1] = O
            }
            for (var q = 0; q < 160; q += 2) {
                z = t[q], O = t[q + 1];
                var K = h(r, i, n), F = h(w, _, S), H = d(r, w), Y = d(w, r), V = u(f, E), W = u(E, f), X = o[q],
                    G = o[q + 1], J = c(f, s, v), Z = c(E, A, k), $ = x + W | 0, Q = g + V + m($, x) | 0;
                Q = (Q = (Q = Q + J + m($ = $ + Z | 0, Z) | 0) + X + m($ = $ + G | 0, G) | 0) + z + m($ = $ + O | 0, O) | 0;
                var ee = Y + F | 0, te = H + K + m(ee, Y) | 0;
                g = v, x = k, v = s, k = A, s = f, A = E, f = a + Q + m(E = M + $ | 0, M) | 0, a = n, M = S, n = i, S = _, i = r, _ = w, r = Q + te + m(w = $ + ee | 0, $) | 0
            }
            this._al = this._al + w | 0, this._bl = this._bl + _ | 0, this._cl = this._cl + S | 0, this._dl = this._dl + M | 0, this._el = this._el + E | 0, this._fl = this._fl + A | 0, this._gl = this._gl + k | 0, this._hl = this._hl + x | 0, this._ah = this._ah + r + m(this._al, w) | 0, this._bh = this._bh + i + m(this._bl, _) | 0, this._ch = this._ch + n + m(this._cl, S) | 0, this._dh = this._dh + a + m(this._dl, M) | 0, this._eh = this._eh + f + m(this._el, E) | 0, this._fh = this._fh + s + m(this._fl, A) | 0, this._gh = this._gh + v + m(this._gl, k) | 0, this._hh = this._hh + g + m(this._hl, x) | 0
        }, s.prototype._hash = function () {
        ...
        "use strict";
        var i = r(0), n = r(102), a = r(9), o = r(1).Buffer, f = r(28), s = r(29), c = r(34), h = o.alloc(128);

        function d(e, t) {
            a.call(this, "digest"), "string" == typeof t && (t = o.from(t));
            var r = "sha512" === e || "sha384" === e ? 128 : 64;
            (this._alg = e, this._key = t, t.length > r) ? t = ("rmd160" === e ? new s : c(e)).update(t).digest() : t.length < r && (t = o.concat([t, h], r));
            for (var i = this._ipad = o.allocUnsafe(r), n = this._opad = o.allocUnsafe(r), f = 0; f < r; f++) i[f] = 54 ^ t[f], n[f] = 92 ^ t[f];
        ...
        var i = r(28), n = r(29), a = r(34), o = r(51), f = r(52), s = r(1).Buffer, c = s.alloc(128),
        ...
        function d(e, t, r) {
            ...
            for (var d = s.allocUnsafe(f + h[e]), u = s.allocUnsafe(f + h[e]), l = 0; l < f; l++) d[l] = 54 ^ t[l], u[l] = 92 ^ t[l];
            var p = s.allocUnsafe(f + r + 4);
            d.copy(p, 0, 0, f), this.ipad1 = p, this.ipad2 = d, this.opad = u, this.alg = e, this.blocksize = f, this.hash = o, this.size = h[e]
        }
        ...
        d.prototype.run = function (e, t) {
            ...
            s.isBuffer(e) || (e = s.from(e, f)), s.isBuffer(t) || (t = s.from(t, f)), o(r, i);
            var a = new d(n = n || "sha1", e, t.length), c = s.allocUnsafe(i), u = s.allocUnsafe(t.length + 4);
            t.copy(u, 0, 0, t.length);
            for (var l = 0, p = h[n], b = Math.ceil(i / p), y = 1; y <= b; y++) {
                u.writeUInt32BE(y, t.length);
                for (var m = a.run(u, a.ipad1), v = m, g = 1; g < r; g++) {
                    v = a.run(v, a.ipad2);
        ...
        var i = r(17), n = r(1).Buffer, a = r(55);
        ...
        var i = r(24), n = r(1).Buffer, a = r(9), o = r(0), f = r(115), s = r(17), c = r(55);
        ...
        function h(e, t, r, o) {
            ...
            this._ghash = new f(h), r = function (e, t, r) {
                ...
                var i = new f(r), a = t.length, o = a % 16;
                i.update(t), o && (o = 16 - o, i.update(n.alloc(o, 0))), i.update(n.alloc(8, 0));
                var s = 8 * a, h = n.alloc(8);
                h.writeUIntBE(s, 0, 8), i.update(h), e._finID = i.state;
                var d = n.from(e._finID);
                return c(d), d
            }(this, r, h), this._prev = n.from(r), this._cache = n.allocUnsafe(0), this._secCache = n.allocUnsafe(0), this._decrypt = o, this._alen = 0, this._len = 0, this._mode = e, this._authTag = null, this._called = !1
        }

        o(h, a), h.prototype._update = function (e) {
        ...
        r(0)(o, a), o.prototype._update = function (e) {
        ...
        var n = r(2), a = new n(24), o = new (r(60)), f = new n(1), s = new n(2), c = new n(5),
            h = (new n(16), new n(8), new n(10)), d = new n(3), u = (new n(7), new n(11)), l = new n(4),
            p = (new n(12), null);
        ...
        function v(e, t) {
            ...
            for (t = new n(t); ;) {
                ...
                if (y(p = r.shrn(1)) && y(r) && m(p) && m(r) && o.test(p) && o.test(r)) return r
            }
        }
    }, function (e, t, r) {
        var i = r(2), n = r(61);
        ...
        e.exports = a, a.create = function (e) {
            ...
            var n = e.bitLength(), a = i.mont(e), o = new i(1).toRed(a);
            ...
            for (var s = e.shrn(f), c = o.toRed(n); t > 0; t--) {
                var h = this._randrange(new i(2), o), d = e.gcd(h);
        ...
        "use strict";
        var i = r(6), n = r(18), a = r(63), o = r(5), f = i.sum32, s = i.sum32_4, c = i.sum32_5, h = a.ch32,
            d = a.maj32, u = a.s0_256, l = a.s1_256, p = a.g0_256, b = a.g1_256, y = n.BlockHash,
        ...
        i.inherits(v, y), e.exports = v, v.blockSize = 512, v.outSize = 256, v.hmacStrength = 192, v.padLength = 64, v.prototype._update = function (e, t) {
            for (var r = this.W, i = 0; i < 16; i++) r[i] = e[t + i];
            for (; i < r.length; i++) r[i] = s(b(r[i - 2]), r[i - 7], p(r[i - 15]), r[i - 16]);
            var n = this.h[0], a = this.h[1], y = this.h[2], m = this.h[3], v = this.h[4], g = this.h[5], w = this.h[6],
                _ = this.h[7];
            for (o(this.k.length === r.length), i = 0; i < r.length; i++) {
                var S = c(_, l(v), h(v, g, w), this.k[i], r[i]), M = f(u(n), d(n, a, y));
                _ = w, w = g, g = v, v = f(m, S), m = y, y = a, a = n, n = f(S, M)
            }
            this.h[0] = f(this.h[0], n), this.h[1] = f(this.h[1], a), this.h[2] = f(this.h[2], y), this.h[3] = f(this.h[3], m), this.h[4] = f(this.h[4], v), this.h[5] = f(this.h[5], g), this.h[6] = f(this.h[6], w), this.h[7] = f(this.h[7], _)
        }, v.prototype._digest = function (e) {
            return "hex" === e ? i.toHex32(this.h, "big") : i.split32(this.h, "big")
        }
    }, function (e, t, r) {
        "use strict";
        var i = r(6), n = r(18), a = r(5), o = i.rotr64_hi, f = i.rotr64_lo, s = i.shr64_hi, c = i.shr64_lo,
            h = i.sum64, d = i.sum64_hi, u = i.sum64_lo, l = i.sum64_4_hi, p = i.sum64_4_lo, b = i.sum64_5_hi,
            y = i.sum64_5_lo, m = n.BlockHash,
        ...
        i.inherits(g, m), e.exports = g, g.blockSize = 1024, g.outSize = 512, g.hmacStrength = 192, g.padLength = 128, g.prototype._prepareBlock = function (e, t) {
            for (var r = this.W, i = 0; i < 32; i++) r[i] = e[t + i];
            for (; i < r.length; i += 2) {
                var n = R(r[i - 4], r[i - 3]), a = P(r[i - 4], r[i - 3]), o = r[i - 14], f = r[i - 13],
                    s = B(r[i - 30], r[i - 29]), c = I(r[i - 30], r[i - 29]), h = r[i - 32], d = r[i - 31];
                r[i] = l(n, a, o, f, s, c, h, d), r[i + 1] = p(n, a, o, f, s, c, h, d)
            }
        }, g.prototype._update = function (e, t) {
            this._prepareBlock(e, t);
            var r = this.W, i = this.h[0], n = this.h[1], o = this.h[2], f = this.h[3], s = this.h[4], c = this.h[5],
                l = this.h[6], p = this.h[7], m = this.h[8], v = this.h[9], g = this.h[10], B = this.h[11],
                I = this.h[12], R = this.h[13], P = this.h[14], T = this.h[15];
            a(this.k.length === r.length);
            for (var C = 0; C < r.length; C += 2) {
                var j = P, U = T, L = k(m, v), N = x(m, v), D = w(m, v, g, B, I), O = _(m, v, g, B, I, R),
                    z = this.k[C], q = this.k[C + 1], K = r[C], F = r[C + 1], H = b(j, U, L, N, D, O, z, q, K, F),
                    Y = y(j, U, L, N, D, O, z, q, K, F);
                j = E(i, n), U = A(i, n), L = S(i, n, o, f, s), N = M(i, n, o, f, s, c);
                var V = d(j, U, L, N), W = u(j, U, L, N);
                P = I, T = R, I = g, R = B, g = m, B = v, m = d(l, p, H, Y), v = u(p, p, H, Y), l = s, p = c, s = o, c = f, o = i, f = n, i = d(H, Y, V, W), n = u(H, Y, V, W)
            }
            h(this.h, 0, i, n), h(this.h, 2, o, f), h(this.h, 4, s, c), h(this.h, 6, l, p), h(this.h, 8, m, v), h(this.h, 10, g, B), h(this.h, 12, I, R), h(this.h, 14, P, T)
        }, g.prototype._digest = function (e) {
            return "hex" === e ? i.toHex32(this.h, "big") : i.split32(this.h, "big")
        }
    }, function (e, t, r) {
        var i = r(0), n = r(20).Reporter, a = r(3).Buffer;
        ...
        i(o, n), t.DecoderBuffer = o, o.prototype.save = function () {
        ...
        var i = r(0), n = r(19), a = n.base, o = n.bignum, f = n.constants.der;
        ...
        e.exports = s, s.prototype.decode = function (e, t) {
        ...
        }, i(c, a.Node), c.prototype._peekTag = function (e, t, r) {
            ...
            if ("gentime" === t) var i = 0 | r.slice(0, 4), n = 0 | r.slice(4, 6), a = 0 | r.slice(6, 8),
                o = 0 | r.slice(8, 10), f = 0 | r.slice(10, 12), s = 0 | r.slice(12, 14); else {
                if ("utctime" !== t) return e.error("Decoding " + t + " time is not supported yet");
                i = 0 | r.slice(0, 2), n = 0 | r.slice(2, 4), a = 0 | r.slice(4, 6), o = 0 | r.slice(6, 8), f = 0 | r.slice(8, 10), s = 0 | r.slice(10, 12);
                i = i < 70 ? 2e3 + i : 1900 + i
            }
            ...
            var r = e.raw(), i = new o(r);
            return t && (i = t[i.toString(10)] || i), i
        }, c.prototype._use = function (e, t) {
            return "function" == typeof e && (e = e(t)), e._getDecoder("der").tree
        }
    }, function (e, t, r) {
        var i = r(0), n = r(3).Buffer, a = r(19), o = a.base, f = a.constants.der;
        ...
        e.exports = s, s.prototype.encode = function (e, t) {
        ...
        }, i(c, o.Node), c.prototype._encodeComposite = function (e, t, r, i) {
            ...
            var r, i = new Date(e);
            return "gentime" === t ? r = [h(i.getFullYear()), h(i.getUTCMonth() + 1), h(i.getUTCDate()), h(i.getUTCHours()), h(i.getUTCMinutes()), h(i.getUTCSeconds()), "Z"].join("") : "utctime" === t ? r = [h(i.getFullYear() % 100), h(i.getUTCMonth() + 1), h(i.getUTCDate()), h(i.getUTCHours()), h(i.getUTCMinutes()), h(i.getUTCSeconds()), "Z"].join("") : this.reporter.error("Encoding " + t + " time is not supported yet"), this._encodeStr(r, "octstr")
        ...
        (function (t) {
            ...
            e.exports = function (e, r) {
                for (var a, o = new t(""), f = 0; o.length < r;) a = n(f++), o = t.concat([o, i("sha1").update(e).update(a).digest()]);
                return o.slice(0, r)
            }
        }).call(t, r(3).Buffer)
    }, function (e, t) {
        ...
        e.exports = {
            bits: a, int: function (e, t) {
                let r, o = e.bitLength();
                for (; ;) if (bytes = a(o, !1, t), (r = new i(bytes)).cmp(n.zeroBN) > 0 && r.cmp(e) < 0) return bytes
            }
        }
    }, function (e, t, r) {
        "use strict";
        ...
        "use strict";
        const i = r(2), n = r(11), a = r(27), o = r(75), f = r(10);

        class s extends f.Point {
            constructor(e, t, r) {
                super();
                let n = t || null, a = r || null;
                void 0 !== t && t.constructor === Uint8Array && (n = new i(t, 16, "le")), void 0 !== r && r.constructor === Uint8Array && (a = new i(r, 16, "le")), this.ref = {
                    curve: e,
                    point: e.curve.point(n, a)
            ...
            clone() {
                ...
                return new s(this.ref.curve, e.x, e.y)
            }
            ...
            embed(e, t) {
                ...
                let r = this.ref.curve._coordLen(), a = this.embedLen();
                if (e.length > a) throw new Error("data.length > dl");
                for (a > e.length && (a = e.length), t = t || n.randomBytes; ;) {
                    const n = this.ref.curve.curve.p.bitLength();
                    let o = t(n >> 3), f = Uint8Array.from(o), c = 7 & n;
                    0 != c && (f[0] &= ~(255 << c)), a > 0 && (f[r - 1] = a, f.set(e, r - a - 1));
                    let h = new i(f, 16, "be");
                    if (h.cmp(this.ref.curve.curve.p) > 0) continue;
                    let d = h.toRed(this.ref.curve.curve.red), u = d.redMul(this.ref.curve.curve.a),
                        l = d.redSqr().redMul(d).redAdd(u).redAdd(this.ref.curve.curve.b), p = l.redSqrt();
                    if (0 != (128 & t(1)[0]) && (p = this.ref.curve.curve.p.sub(p).toRed(this.ref.curve.curve.red)), 0 === p.redSqr().cmp(l)) return new s(this.ref.curve, d, p)
                }
            }
            ...
            mul(e, t) {
                if (e.constructor !== a) throw new TypeError("s should be a Scalar");
                t = t || null;
            ...
            unmarshalBinary(e) {
                ...
                if (0 === r.cmp(o.zeroBN) && 0 === n.cmp(o.zeroBN)) return this.ref.point = this.ref.curve.curve.point(null, null), this;
        ...
        "use strict";
        const i = r(2), n = r(11), a = r(40), o = r(10);

        class f extends o.Point {
            constructor(e, t, r, n, a) {
                super();
                let o = t, f = r, s = n, c = a;
                void 0 !== t && t.constructor === Uint8Array && (o = new i(t, 16, "le")), void 0 !== r && r.constructor === Uint8Array && (f = new i(r, 16, "le")), void 0 !== n && n.constructor === Uint8Array && (s = new i(n, 16, "le")), void 0 !== a && a.constructor === Uint8Array && (c = new i(a, 16, "le")), this.ref = {
                    point: e.curve.point(o, f, s, c),
                    curve: e
                }, this.string = this.toString.bind(this), this.inspect = this.toString.bind(this)
            }
            ...
            clone() {
                const e = this.ref.point;
                return new f(this.ref.curve, e.x, e.y, e.z, e.t)
            }
            ...
            embed(e, t) {
                ...
                let a = new f(this.ref.curve);
                for (; ;) {
                    let n = t(32), o = Uint8Array.from(n);
                    r > 0 && (o[0] = r, o.set(e, 1));
                    new i(o, 16, "le");
                    try {
                        a.unmarshalBinary(o)
                    ...
                    if (0 == r) {
                        if (a.ref.point = a.ref.point.mul(new i(8)), a.ref.point.isInfinity()) continue;
                        return a
                    }
                    let f = a.clone();
                    if (f.ref.point = f.ref.point.mul(this.ref.curve.curve.n), f.ref.point.isInfinity()) return a
                }
            }
        ...
        "use strict";
        const i = r(80), n = r(172), a = {};
        a.edwards25519 = n.Curve, a.p256 = i.Curve.bind(i.Params.p256), e.exports = {
            nist: i,
            edwards25519: n,
            ...
            newCurve: function (e) {
                if (!(e in a)) throw new Error("curve not known");
                return new a[e]
            }
        }
    }, function (e, t, r) {
        "use strict";
        const i = r(81), n = r(76), a = r(27), o = r(171);
        e.exports = {Curve: i, Point: n, Scalar: a, Params: o}
    }, function (e, t, r) {
        "use strict";
        const i = r(27), n = r(76), a = (r(11), r(4)), o = r(2), f = r(10);
        e.exports = class extends f.Group {
            constructor(e) {
                super();
                let {name: t, bitSize: r, gx: i, gy: n} = e, f = function (e, t) {
                    var r = {};
                    for (var i in e) t.indexOf(i) >= 0 || Object.prototype.hasOwnProperty.call(e, i) && (r[i] = e[i]);
                    return r
                }(e, ["name", "bitSize", "gx", "gy"]);
                this.name = t, f.g = [new o(i, 16, "le"), new o(n, 16, "le")];
                for (let e in f) "g" !== e && (f[e] = new o(f[e], 16, "le"));
                this.curve = new a.curve.short(f), this.bitSize = r, this.redN = o.red(f.n)
            }
        ...
        t.byteLength = function (e) {
            ...
            var t, r, i, o, f, s = e.length;
            o = c(e), f = new a(3 * s / 4 - o), r = o > 0 ? s - 4 : s;
            var h = 0;
            for (t = 0; t < r; t += 4) i = n[e.charCodeAt(t)] << 18 | n[e.charCodeAt(t + 1)] << 12 | n[e.charCodeAt(t + 2)] << 6 | n[e.charCodeAt(t + 3)], f[h++] = i >> 16 & 255, f[h++] = i >> 8 & 255, f[h++] = 255 & i;
            2 === o ? (i = n[e.charCodeAt(t)] << 2 | n[e.charCodeAt(t + 1)] >> 4, f[h++] = 255 & i) : 1 === o && (i = n[e.charCodeAt(t)] << 10 | n[e.charCodeAt(t + 1)] << 4 | n[e.charCodeAt(t + 2)] >> 2, f[h++] = i >> 8 & 255, f[h++] = 255 & i);
            return f
        }, t.fromByteArray = function (e) {
            for (var t, r = e.length, n = r % 3, a = "", o = [], f = 0, s = r - n; f < s; f += 16383) o.push(h(e, f, f + 16383 > s ? s : f + 16383));
            1 === n ? (t = e[r - 1], a += i[t >> 2], a += i[t << 4 & 63], a += "==") : 2 === n && (t = (e[r - 2] << 8) + e[r - 1], a += i[t >> 10], a += i[t >> 4 & 63], a += i[t << 2 & 63], a += "=");
            return o.push(a), o.join("")
        };
        for (var i = [], n = [], a = "undefined" != typeof Uint8Array ? Uint8Array : Array, o = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", f = 0, s = o.length; f < s; ++f) i[f] = o[f], n[o.charCodeAt(f)] = f;
        ...
        function h(e, t, r) {
            for (var n, a, o = [], f = t; f < r; f += 3) n = (e[f] << 16) + (e[f + 1] << 8) + e[f + 2], o.push(i[(a = n) >> 18 & 63] + i[a >> 12 & 63] + i[a >> 6 & 63] + i[63 & a]);
            return o.join("")
        }
        ...
        t.read = function (e, t, r, i, n) {
            var a, o, f = 8 * n - i - 1, s = (1 << f) - 1, c = s >> 1, h = -7, d = r ? n - 1 : 0, u = r ? -1 : 1,
                l = e[t + d];
            for (d += u, a = l & (1 << -h) - 1, l >>= -h, h += f; h > 0; a = 256 * a + e[t + d], d += u, h -= 8) ;
            for (o = a & (1 << -h) - 1, a >>= -h, h += i; h > 0; o = 256 * o + e[t + d], d += u, h -= 8) ;
            if (0 === a) a = 1 - c; else {
            ...
            var o, f, s, c = 8 * a - n - 1, h = (1 << c) - 1, d = h >> 1,
                u = 23 === n ? Math.pow(2, -24) - Math.pow(2, -77) : 0, l = i ? 0 : a - 1, p = i ? 1 : -1,
                b = t < 0 || 0 === t && 1 / t < 0 ? 1 : 0;
            for (t = Math.abs(t), isNaN(t) || t === 1 / 0 ? (f = isNaN(t) ? 1 : 0, o = h) : (o = Math.floor(Math.log(t) / Math.LN2), t * (s = Math.pow(2, -o)) < 1 && (o--, s *= 2), (t += o + d >= 1 ? u / s : u * Math.pow(2, 1 - d)) * s >= 2 && (o++, s /= 2), o + d >= h ? (f = 0, o = h) : o + d >= 1 ? (f = (t * s - 1) * Math.pow(2, n), o += d) : (f = t * Math.pow(2, d - 1) * Math.pow(2, n), o = 0)); n >= 8; e[r + l] = 255 & f, l += p, f /= 256, n -= 8) ;
            for (o = o << n | f, c += n; c > 0; e[r + l] = 255 & o, l += p, o /= 256, c -= 8) ;
            e[r + l - p] |= 128 * b
        }
    }, function (e, t, r) {
        "use strict";
        (function (t) {
            ...
            e.exports = function (e, n) {
                var a = n(function (e) {
                    if (e.length % r != 0) {
                        var n = e.length + (r - e.length % r);
                        e = t.concat([e, i], n)
                    }
                    for (var a = new Array(e.length >>> 2), o = 0, f = 0; o < e.length; o += r, f++) a[f] = e.readInt32LE(o);
                    return a
                }(e), 8 * e.length);
                e = new t(16);
                for (var o = 0; o < a.length; o++) e.writeInt32LE(a[o], o << 2, !0);
                return e
            }
        }).call(t, r(3).Buffer)
    }, function (e, t, r) {
        ...
        e.exports = function () {
            ...
            return e.prototype.push = function (e) {
                ...
                for (var t, r, n, a = i.allocUnsafe(e >>> 0), o = this.head, f = 0; o;) t = o.data, r = a, n = f, t.copy(r, n), f += o.data.length, o = o.next;
                return a
            }, e
        }()
    }, function (e, t, r) {
        ...
        (function (e, t) {
            !function (e, r) {
                "use strict";
                if (!e.setImmediate) {
                    var i, n, a, o, f, s = 1, c = {}, h = !1, d = e.document,
                    ...
                    u = u && u.setTimeout ? u : e, "[object process]" === {}.toString.call(e.process) ? i = function (e) {
                    ...
                    }) : d && "onreadystatechange" in d.createElement("script") ? (n = d.documentElement, i = function (e) {
                        ...
                        setTimeout(p, 0, e)
                    } : (o = "setImmediate$" + Math.random() + "$", f = function (t) {
                        t.source === e && "string" == typeof t.data && 0 === t.data.indexOf(o) && p(+t.data.slice(o.length))
                    }, e.addEventListener ? e.addEventListener("message", f, !1) : e.attachEvent("onmessage", f), i = function (t) {
                        e.postMessage(o + t, "*")
        ...
        n.inherits = r(0), n.inherits(a, i), a.prototype._transform = function (e, t, r) {
            r(null, e)
        }
    }, function (e, t, r) {
        e.exports = r(32)
        ...
        var i = r(0), n = r(14), a = r(1).Buffer, o = [1518500249, 1859775393, -1894007588, -899497514],
            f = new Array(80);
        ...
        i(s, n), s.prototype.init = function () {
            ...
            for (var t, r = this._w, i = 0 | this._a, n = 0 | this._b, a = 0 | this._c, f = 0 | this._d, s = 0 | this._e, d = 0; d < 16; ++d) r[d] = e.readInt32BE(4 * d);
            for (; d < 80; ++d) r[d] = r[d - 3] ^ r[d - 8] ^ r[d - 14] ^ r[d - 16];
            for (var u = 0; u < 80; ++u) {
                var l = ~~(u / 20), p = 0 | ((t = i) << 5 | t >>> 27) + h(l, n, a, f) + s + r[u] + o[l];
                s = f, f = a, a = c(n), n = i, i = p
            }
            this._a = i + this._a | 0, this._b = n + this._b | 0, this._c = a + this._c | 0, this._d = f + this._d | 0, this._e = s + this._e | 0
        }, s.prototype._hash = function () {
        ...
        i(s, n), s.prototype.init = function () {
            ...
            for (var t, r = this._w, i = 0 | this._a, n = 0 | this._b, a = 0 | this._c, f = 0 | this._d, s = 0 | this._e, u = 0; u < 16; ++u) r[u] = e.readInt32BE(4 * u);
            for (; u < 80; ++u) r[u] = (t = r[u - 3] ^ r[u - 8] ^ r[u - 14] ^ r[u - 16]) << 1 | t >>> 31;
            for (var l = 0; l < 80; ++l) {
                var p = ~~(l / 20), b = c(i) + d(p, n, a, f) + s + r[l] + o[p] | 0;
                s = f, f = a, a = h(n), n = i, i = b
            }
            this._a = i + this._a | 0, this._b = n + this._b | 0, this._c = a + this._c | 0, this._d = f + this._d | 0, this._e = s + this._e | 0
        }, s.prototype._hash = function () {
            var e = a.allocUnsafe(20);
        ...
        var i = r(0), n = r(46), a = r(14), o = r(1).Buffer, f = new Array(64);
        ...
        var i = r(0), n = r(47), a = r(14), o = r(1).Buffer, f = new Array(160);
        ...
        "use strict";
        var i = r(0), n = r(1).Buffer, a = r(9), o = n.alloc(128), f = 64;

        function s(e, t) {
            a.call(this, "digest"), "string" == typeof t && (t = n.from(t)), this._alg = e, this._key = t, t.length > f ? t = e(t) : t.length < f && (t = n.concat([t, o], f));
            for (var r = this._ipad = n.allocUnsafe(f), i = this._opad = n.allocUnsafe(f), s = 0; s < f; s++) r[s] = 54 ^ t[s], i[s] = 92 ^ t[s];
            this._hash = [r]
        }
        ...
        (function (t, i) {
            var n, a = r(51), o = r(52), f = r(53), s = r(1).Buffer, c = t.crypto && t.crypto.subtle, h = {
                sha: "SHA-1",
                "sha-1": "SHA-1",
                sha1: "SHA-1",
                sha256: "SHA-256",
            ...
            e.exports = function (e, r, l, p, b, y) {
                if (s.isBuffer(e) || (e = s.from(e, o)), s.isBuffer(r) || (r = s.from(r, o)), a(l, p), "function" == typeof b && (y = b, b = void 0), "function" != typeof y) throw new Error("No callback provided to pbkdf2");
                var m = h[(b = b || "sha1").toLowerCase()];
                if (!m || "function" != typeof t.Promise) return i.nextTick(function () {
                    var t;
                    try {
                        t = f(e, r, l, p, b)
                    } catch (e) {
        ...
        "use strict";
        (function (t) {
            var i = r(0), n = r(107), a = new Array(16);
            ...
            function s(e, t, r, i, n, a, o) {
                return f(e + (t & r | ~t & i) + n + a | 0, o) + t | 0
            }

            function c(e, t, r, i, n, a, o) {
                return f(e + (t & i | r & ~i) + n + a | 0, o) + t | 0
            }

            function h(e, t, r, i, n, a, o) {
                return f(e + (t ^ r ^ i) + n + a | 0, o) + t | 0
            }

            function d(e, t, r, i, n, a, o) {
                return f(e + (r ^ (t | ~i)) + n + a | 0, o) + t | 0
            }
        ...
        r(0)(a, n), a.prototype._transform = function (e, t, r) {
            var i = null;
            try {
                this.update(e, t)
            } catch (e) {
        ...
        var i = r(36), n = r(57), a = r(1).Buffer, o = r(58), f = r(9), s = r(24), c = r(23);

        function h(e, t, r) {
            f.call(this), this._cache = new u, this._cipher = new s.AES(t), this._prev = a.from(r), this._mode = e, this._autopadding = !0
        }
        ...
        function l(e, t, r) {
            ...
            if ("string" == typeof t && (t = a.from(t)), t.length !== f.key / 8) throw new TypeError("invalid key length " + t.length);
            if ("string" == typeof r && (r = a.from(r)), "GCM" !== f.mode && r.length !== f.iv) throw new TypeError("invalid iv length " + r.length);
            return "stream" === f.type ? new o(f.module, t, r) : "auth" === f.type ? new n(f.module, t, r) : new h(f.module, t, r)
        }
        ...
        t.encrypt = function (e, t, r) {
            for (var a = t.length, o = i.allocUnsafe(a), f = -1; ++f < a;) o[f] = n(e, t[f], r);
            return o
        }
    }, function (e, t, r) {
        var i = r(1).Buffer;
        ...
        function n(e, t, r) {
            for (var i, n, o, f = -1, s = 0; ++f < 8;) i = e._cipher.encryptBlock(e._prev), n = t & 1 << 7 - f ? 128 : 0, s += (128 & (o = i[0] ^ n)) >> f % 8, e._prev = a(e._prev, r ? n : o);
            return s
        }
        ...
        o.prototype.ghash = function (e) {
            ...
            for (var e, t, r, i = [(e = this.h).readUInt32BE(0), e.readUInt32BE(4), e.readUInt32BE(8), e.readUInt32BE(12)], n = [0, 0, 0, 0], o = -1; ++o < 128;) {
                for (0 != (this.state[~~(o / 8)] & 1 << 7 - o % 8) && (n[0] ^= i[0], n[1] ^= i[1], n[2] ^= i[2], n[3] ^= i[3]), r = 0 != (1 & i[3]), t = 3; t > 0; t--) i[t] = i[t] >>> 1 | (1 & i[t - 1]) << 31;
        ...
        var i = r(57), n = r(1).Buffer, a = r(36), o = r(58), f = r(9), s = r(24), c = r(23);

        function h(e, t, r) {
            f.call(this), this._cache = new d, this._last = void 0, this._cipher = new s.AES(t), this._prev = n.from(r), this._mode = e, this._autopadding = !0
        }
        ...
        function u(e, t, r) {
            ...
            if (!f) throw new TypeError("invalid suite type");
            if ("string" == typeof r && (r = n.from(r)), "GCM" !== f.mode && r.length !== f.iv) throw new TypeError("invalid iv length " + r.length);
            if ("string" == typeof t && (t = n.from(t)), t.length !== f.key / 8) throw new TypeError("invalid key length " + t.length);
            return "stream" === f.type ? new o(f.module, t, r, !0) : "auth" === f.type ? new i(f.module, t, r, !0) : new h(f.module, t, r)
        }
        ...
        (function (t) {
            ...
            function f(e) {
                i.call(this);
                var r, n = e.mode.toLowerCase(), a = o[n];
                r = e.decrypt ? "decrypt" : "encrypt";
                var f = e.key;
                "des-ede" !== n && "des-ede-cbc" !== n || (f = t.concat([f, f.slice(0, 8)]));
                var s = e.iv;
                this._des = a.create({key: f, iv: s, type: r})
            }

            o.des = o["des-cbc"], o.des3 = o["des-ede3-cbc"], e.exports = f, a(f, i), f.prototype._update = function (e) {
        ...
        t.readUInt32BE = function (e, t) {
            ...
            for (var n = 0, a = 0, o = 6; o >= 0; o -= 2) {
                ...
                for (f = 0; f <= 24; f += 8) n <<= 1, n |= e >>> f + o & 1
            }
            for (o = 6; o >= 0; o -= 2) {
            ...
            for (var n = 0, a = 0, o = 0; o < 4; o++) for (var f = 24; f >= 0; f -= 8) n <<= 1, n |= t >>> f + o & 1, n <<= 1, n |= e >>> f + o & 1;
            for (o = 4; o < 8; o++) for (f = 24; f >= 0; f -= 8) a <<= 1, a |= t >>> f + o & 1, a <<= 1, a |= e >>> f + o & 1;
            r[i + 0] = n >>> 0, r[i + 1] = a >>> 0
            ...
            for (f = 0; f <= 24; f += 8) n <<= 1, n |= t >> f + o & 1;
            for (o = 1; o <= 3; o++) {
        ...
        t.pc2 = function (e, t, r, n) {
            for (var a = 0, o = 0, f = i.length >>> 1, s = 0; s < f; s++) a <<= 1, a |= e >>> i[s] & 1;
            for (s = f; s < i.length; s++) o <<= 1, o |= t >>> i[s] & 1;
            r[n + 0] = a >>> 0, r[n + 1] = o >>> 0
        ...
        "use strict";
        var i = r(5), n = r(0), a = r(37), o = a.utils, f = a.Cipher;
        ...
        n(s, f), e.exports = s, s.create = function (e) {
            return new s(e)
        };
        var c = [1, 1, 2, 2, 2, 2, 2, 2, 1, 2, 2, 2, 2, 2, 2, 1];
        s.prototype.deriveKeys = function (e, t) {
            e.keys = new Array(32), i.equal(t.length, this.blockSize, "Invalid key length");
            var r = o.readUInt32BE(t, 0), n = o.readUInt32BE(t, 4);
            o.pc1(r, n, e.tmp, 0), r = e.tmp[0], n = e.tmp[1];
            for (var a = 0; a < e.keys.length; a += 2) {
                var f = c[a >>> 1];
                r = o.r28shl(r, f), n = o.r28shl(n, f), o.pc2(r, n, e.keys, a)
            }
        }, s.prototype._update = function (e, t, r, i) {
            var n = this._desState, a = o.readUInt32BE(e, t), f = o.readUInt32BE(e, t + 4);
            o.ip(a, f, n.tmp, 0), a = n.tmp[0], f = n.tmp[1], "encrypt" === this.type ? this._encrypt(n, a, f, n.tmp, 0) : this._decrypt(n, a, f, n.tmp, 0), a = n.tmp[0], f = n.tmp[1], o.writeUInt32BE(r, a, i), o.writeUInt32BE(r, f, i + 4)
            ...
            for (var a = t, f = r, s = 0; s < e.keys.length; s += 2) {
                var c = e.keys[s], h = e.keys[s + 1];
                o.expand(f, e.tmp, 0), c ^= e.tmp[0], h ^= e.tmp[1];
                var d = o.substitute(c, h), u = f;
                f = (a ^ o.permute(d)) >>> 0, a = u
            }
            o.rip(f, a, i, n)
            ...
            for (var a = r, f = t, s = e.keys.length - 2; s >= 0; s -= 2) {
                ...
                var d = o.substitute(c, h), u = a;
                a = (f ^ o.permute(d)) >>> 0, f = u
            }
            o.rip(a, f, i, n)
        }
    }, function (e, t, r) {
        ...
        t.instantiate = function (e) {
            ...
            if ("encrypt" === this.type) {
                ...
                for (f = 0; f < this.blockSize; f++) o[f] = r[i + f]
            } else {
                a._update.call(this, e, t, r, i);
                for (f = 0; f < this.blockSize; f++) r[i + f] ^= o[f];
                for (f = 0; f < this.blockSize; f++) o[f] = e[t + f]
            }
        }
    }, function (e, t, r) {
        "use strict";
        var i = r(5), n = r(0), a = r(37), o = a.Cipher, f = a.DES;
        ...
        function s(e) {
            ...
            var t = new function (e, t) {
                ...
                this.ciphers = "encrypt" === e ? [f.create({type: "encrypt", key: r}), f.create({
                    type: "decrypt",
                    key: n
                }), f.create({type: "encrypt", key: a})] : [f.create({
                    type: "decrypt",
                    key: a
                }), f.create({type: "encrypt", key: n}), f.create({type: "decrypt", key: r})]
            }(this.type, this.options.key);
            this._edeState = t
        }

        n(s, o), e.exports = s, s.create = function (e) {
            return new s(e)
        }, s.prototype._update = function (e, t, r, i) {
        ...
        (function (e) {
            ...
            t.DiffieHellmanGroup = t.createDiffieHellmanGroup = t.getDiffieHellman = function (t) {
                ...
                return new a(r, i)
            }, t.createDiffieHellman = t.DiffieHellman = function t(r, n, f, s) {
                return e.isBuffer(n) || void 0 === o[n] ? t(r, "binary", n, f) : (n = n || "binary", s = s || "binary", f = f || new e([2]), e.isBuffer(f) || (f = new e(f, s)), "number" == typeof r ? new a(i(r, f), f, !0) : (e.isBuffer(r) || (r = new e(r, n)), new a(r, f, !0)))
            }
        }).call(t, r(3).Buffer)
    }, function (e, t) {
    }, function (e, t) {
        ...
        (function (t) {
            var i = r(2), n = new (r(60)), a = new i(24), o = new i(11), f = new i(10), s = new i(3), c = new i(7),
                h = r(59), d = r(13);
            ...
            Object.defineProperty(b.prototype, "verifyError", {
                enumerable: !0, get: function () {
                    return "number" != typeof this._primeCode && (this._primeCode = function (e, t) {
                        ...
                        var d, u = 0;
                        if (e.isEven() || !h.simpleSieve || !h.fermatTest(e) || !n.test(e)) return u += 1, u += "02" === r || "05" === r ? 8 : 4, p[i] = u, u;
                ...
                var r = (e = (e = new i(e)).toRed(this._prime)).redPow(this._priv).fromRed(), n = new t(r.toArray()),
                    a = this.getPrime();
        ...
        (function (t) {
            var i = r(15), n = r(21), a = r(0), o = r(129), f = r(165), s = r(49);
            ...
            }), a(c, n.Writable), c.prototype._write = function (e, t, r) {
            ...
            }, a(h, n.Writable), h.prototype._write = function (e, t, r) {
                this._hash.update(e), r()
        ...
        (function (t) {
            var i = r(48), n = r(38), a = r(4).ec, o = r(2), f = r(26), s = r(70);
            ...
            function c(e, r, n, a) {
                ...
                c.fill(1);
                var d = new t(f);
                return d.fill(0), d = i(a, d).update(c).update(new t([0])).update(e).update(s).digest(), c = i(a, d).update(c).digest(), {
                    k: d = i(a, d).update(c).update(new t([1])).update(e).update(s).digest(),
            ...
            function d(e, r, n) {
                var a, o;
                do {
                    for (a = new t(0); 8 * a.length < e.bitLength();) r.v = i(n, r.k).update(r.v).digest(), a = t.concat([a, r.v]);
                    o = h(a, e), r.k = i(n, r.k).update(r.v).update(new t([0])).digest(), r.v = i(n, r.k).update(r.v).digest()
                } while (-1 !== o.cmp(e));
                return o
            }
            ...
            e.exports = function (e, r, i, l, p) {
                ...
                if ("dsa" === b.type) {
                    ...
                    return function (e, r, i) {
                        for (var n, a = r.params.priv_key, f = r.params.p, s = r.params.q, l = r.params.g, p = new o(0), b = h(e, s).mod(s), y = !1, m = c(a, s, e, i); !1 === y;) n = d(s, m, i), p = u(l, n, f, s), 0 === (y = n.invm(s).imul(b.add(a.mul(p))).mod(s)).cmpn(0) && (y = !1, p = new o(0));
                        return function (e, r) {
        ...
        "use strict";
        var i = t, n = r(2), a = r(5), o = r(62);
        i.assert = a, i.toArray = o.toArray, i.zero2 = o.zero2, i.toHex = o.toHex, i.encode = o.encode, i.getNAF = function (e, t) {
            for (var r = [], i = 1 << t + 1, n = e.clone(); n.cmpn(1) >= 0;) {
                ...
                r.push(a);
                for (var f = 0 !== n.cmpn(0) && 0 === n.andln(i - 1) ? t + 1 : 1, s = 1; s < f; s++) r.push(0);
                n.iushrn(f)
            }
            return r
            ...
            for (var i = 0, n = 0; e.cmpn(-i) > 0 || t.cmpn(-n) > 0;) {
                var a, o, f, s = e.andln(3) + i & 3, c = t.andln(3) + n & 3;
                3 === s && (s = -1), 3 === c && (c = -1), a = 0 == (1 & s) ? 0 : 3 != (f = e.andln(7) + i & 7) && 5 !== f || 2 !== c ? s : -s, r[0].push(a), o = 0 == (1 & c) ? 0 : 3 != (f = t.andln(7) + n & 7) && 5 !== f || 2 !== s ? c : -c, r[1].push(o), 2 * i === a + 1 && (i = 1 - i), 2 * n === o + 1 && (n = 1 - n), e.iushrn(1), t.iushrn(1)
            }
            return r
        ...
        "use strict";
        var i = r(2), n = r(4).utils, a = n.getNAF, o = n.getJSF, f = n.assert;
        ...
        e.exports = s, s.prototype.point = function () {
            ...
            for (var h = this.jpoint(null, null, null), d = this.jpoint(null, null, null), u = n; u > 0; u--) {
                for (s = 0; s < o.length; s++) {
                    (c = o[s]) === u ? d = d.mixedAdd(r.points[s]) : c === -u && (d = d.mixedAdd(r.points[s].neg()))
                }
                h = h.add(d)
            }
            return h.toP()
            ...
            r = i.wnd;
            for (var n = i.points, o = a(t, r), s = this.jpoint(null, null, null), c = o.length - 1; c >= 0; c--) {
                for (t = 0; c >= 0 && 0 === o[c]; c--) t++;
                if (c >= 0 && t++, s = s.dblp(t), c < 0) break;
                var h = o[c];
                f(0 !== h), s = "affine" === e.type ? h > 0 ? s.mixedAdd(n[h - 1 >> 1]) : s.mixedAdd(n[-h - 1 >> 1].neg()) : h > 0 ? s.add(n[h - 1 >> 1]) : s.add(n[-h - 1 >> 1].neg())
            }
            return "affine" === e.type ? s.toP() : s
        }, s.prototype._wnafMulAdd = function (e, t, r, i, n) {
            for (var f = this._wnafT1, s = this._wnafT2, c = this._wnafT3, h = 0, d = 0; d < i; d++) {
            ...
            for (d = i - 1; d >= 1; d -= 2) {
                ...
                if (1 === f[l] && 1 === f[p]) {
                    ...
                    var y = [-3, -1, -5, -7, 0, 7, 5, 1, 3], m = o(r[l], r[p]);
                    h = Math.max(m[0].length, h), c[l] = new Array(h), c[p] = new Array(h);
                    for (var v = 0; v < h; v++) {
                        var g = 0 | m[0][v], w = 0 | m[1][v];
                        c[l][v] = y[3 * (g + 1) + (w + 1)], c[p][v] = 0, s[l] = b
                    }
                } else c[l] = a(r[l], f[l]), c[p] = a(r[p], f[p]), h = Math.max(c[l].length, h), h = Math.max(c[p].length, h)
            }
            var _ = this.jpoint(null, null, null), S = this._wnafT4;
            for (d = h; d >= 0; d--) {
                for (var M = 0; d >= 0;) {
                    var E = !0;
                    for (v = 0; v < i; v++) S[v] = 0 | c[v][d], 0 !== S[v] && (E = !1);
                    if (!E) break;
                    M++, d--
                }
                ...
                for (v = 0; v < i; v++) {
                    var A, k = S[v];
                    0 !== k && (k > 0 ? A = s[v][k - 1 >> 1] : k < 0 && (A = s[v][-k - 1 >> 1].neg()), _ = "affine" === A.type ? _.mixedAdd(A) : _.add(A))
                }
            }
        ...
        "use strict";
        var i = r(25), n = r(4), a = r(2), o = r(0), f = i.base, s = n.utils.assert;
        ...
        function h(e, t, r, i) {
            f.BasePoint.call(this, e, "affine"), null === t && null === r ? (this.x = null, this.y = null, this.inf = !0) : (this.x = new a(t, 16), this.y = new a(r, 16), i && (this.x.forceRed(this.curve.red), this.y.forceRed(this.curve.red)), this.x.red || (this.x = this.x.toRed(this.curve.red)), this.y.red || (this.y = this.y.toRed(this.curve.red)), this.inf = !1)
        }

        function d(e, t, r, i) {
            f.BasePoint.call(this, e, "jacobian"), null === t && null === r && null === i ? (this.x = this.curve.one, this.y = this.curve.one, this.z = new a(0)) : (this.x = new a(t, 16), this.y = new a(r, 16), this.z = new a(i, 16)), this.x.red || (this.x = this.x.toRed(this.curve.red)), this.y.red || (this.y = this.y.toRed(this.curve.red)), this.z.red || (this.z = this.z.toRed(this.curve.red)), this.zOne = this.z === this.curve.one
        }

        o(c, f), e.exports = c, c.prototype._getEndomorphism = function (e) {
            ...
            var t = e === this.p ? this.red : a.mont(e), r = new a(2).toRed(t).redInvm(), i = r.redNeg(),
            ...
            for (var t, r, i, n, o, f, s, c, h, d = this.n.ushrn(Math.floor(this.n.bitLength() / 2)), u = e, l = this.n.clone(), p = new a(1), b = new a(0), y = new a(0), m = new a(1), v = 0; 0 !== u.cmpn(0);) {
                var g = l.div(u);
                c = l.sub(g.mul(u)), h = y.sub(g.mul(p));
                var w = m.sub(g.mul(b));
                if (!i && c.cmp(d) < 0) t = s.neg(), r = p, i = c.neg(), n = h; else if (i && 2 == ++v) break;
                s = c, l = u, u = c, y = p, p = h, m = b, b = w
            }
            o = c.neg(), f = h;
            var _ = i.sqr().add(n.sqr());
            return o.sqr().add(f.sqr()).cmp(_) >= 0 && (o = t, f = r), i.negative && (i = i.neg(), n = n.neg()), o.negative && (o = o.neg(), f = f.neg()), [{
                a: i,
                b: n
            }, {a: o, b: f}]
        }, c.prototype._endoSplit = function (e) {
            var t = this.endo.basis, r = t[0], i = t[1], n = i.b.mul(e).divRound(this.n),
                a = r.b.neg().mul(e).divRound(this.n), o = n.mul(r.a), f = a.mul(i.a), s = n.mul(r.b), c = a.mul(i.b);
            ...
            for (var i = this._endoWnafT1, n = this._endoWnafT2, a = 0; a < e.length; a++) {
                var o = this._endoSplit(t[a]), f = e[a], s = f._getBeta();
            ...
            return c
        }, o(h, f.BasePoint), c.prototype.point = function (e, t, r) {
            ...
            var t = this.curve.a, r = this.x.redSqr(), i = e.redInvm(), n = r.redAdd(r).redIAdd(r).redIAdd(t).redMul(i),
                a = n.redSqr().redISub(this.x.redAdd(this.x)), o = n.redMul(this.x.redSub(a)).redISub(this.y);
        ...
        }, o(d, f.BasePoint), c.prototype.jpoint = function (e, t, r) {
            ...
            var t = e.z.redSqr(), r = this.z.redSqr(), i = this.x.redMul(t), n = e.x.redMul(r),
                a = this.y.redMul(t.redMul(e.z)), o = e.y.redMul(r.redMul(this.z)), f = i.redSub(n), s = a.redSub(o);
            if (0 === f.cmpn(0)) return 0 !== s.cmpn(0) ? this.curve.jpoint(null, null, null) : this.dbl();
            var c = f.redSqr(), h = c.redMul(f), d = i.redMul(c), u = s.redSqr().redIAdd(h).redISub(d).redISub(d),
                l = s.redMul(d.redISub(u)).redISub(a.redMul(h)), p = this.z.redMul(e.z).redMul(f);
            ...
            var t = this.z.redSqr(), r = this.x, i = e.x.redMul(t), n = this.y, a = e.y.redMul(t).redMul(this.z),
                o = r.redSub(i), f = n.redSub(a);
            if (0 === o.cmpn(0)) return 0 !== f.cmpn(0) ? this.curve.jpoint(null, null, null) : this.dbl();
            var s = o.redSqr(), c = s.redMul(o), h = r.redMul(s), d = f.redSqr().redIAdd(c).redISub(h).redISub(h),
                u = f.redMul(h.redISub(d)).redISub(n.redMul(c)), l = this.z.redMul(o);
            ...
            var i = this.curve.a, n = this.curve.tinv, a = this.x, o = this.y, f = this.z, s = f.redSqr().redSqr(),
                c = o.redAdd(o);
            for (r = 0; r < e; r++) {
                var h = a.redSqr(), d = c.redSqr(), u = d.redSqr(), l = h.redAdd(h).redIAdd(h).redIAdd(i.redMul(s)),
                    p = a.redMul(d), b = l.redSqr().redISub(p.redAdd(p)), y = p.redISub(b), m = l.redMul(y);
                m = m.redIAdd(m).redISub(u);
                var v = c.redMul(f);
                r + 1 < e && (s = s.redMul(u)), a = b, f = v, c = m
            }
            ...
            if (this.zOne) {
                ...
                o = o.redIAdd(o);
                var f = i.redAdd(i).redIAdd(i), s = f.redSqr().redISub(o).redISub(o), c = a.redIAdd(a);
                c = (c = c.redIAdd(c)).redIAdd(c), e = s, t = f.redMul(o.redISub(s)).redISub(c), r = this.y.redAdd(this.y)
            } else {
                var h = this.x.redSqr(), d = this.y.redSqr(), u = d.redSqr(),
                    l = this.x.redAdd(d).redSqr().redISub(h).redISub(u);
                l = l.redIAdd(l);
                var p = h.redAdd(h).redIAdd(h), b = p.redSqr(), y = u.redIAdd(u);
            ...
            if (this.zOne) {
                var i = this.x.redSqr(), n = this.y.redSqr(), a = n.redSqr(),
                    o = this.x.redAdd(n).redSqr().redISub(i).redISub(a);
                o = o.redIAdd(o);
                var f = i.redAdd(i).redIAdd(i).redIAdd(this.curve.a), s = f.redSqr().redISub(o).redISub(o);
                e = s;
                var c = a.redIAdd(a);
                c = (c = c.redIAdd(c)).redIAdd(c), t = f.redMul(o.redISub(s)).redISub(c), r = this.y.redAdd(this.y)
            } else {
                var h = this.z.redSqr(), d = this.y.redSqr(), u = this.x.redMul(d),
            ...
            var e = this.curve.a, t = this.x, r = this.y, i = this.z, n = i.redSqr().redSqr(), a = t.redSqr(),
                o = r.redSqr(), f = a.redAdd(a).redIAdd(a).redIAdd(e.redMul(n)), s = t.redAdd(t),
                c = (s = s.redIAdd(s)).redMul(o), h = f.redSqr().redISub(c.redAdd(c)), d = c.redISub(h), u = o.redSqr();
            ...
            var e = this.x.redSqr(), t = this.y.redSqr(), r = this.z.redSqr(), i = t.redSqr(),
                n = e.redAdd(e).redIAdd(e), a = n.redSqr(), o = this.x.redAdd(t).redSqr().redISub(e).redISub(i),
                f = (o = (o = (o = o.redIAdd(o)).redAdd(o).redIAdd(o)).redISub(a)).redSqr(), s = i.redIAdd(i);
            s = (s = (s = s.redIAdd(s)).redIAdd(s)).redIAdd(s);
            var c = n.redIAdd(o).redSqr().redISub(a).redISub(f).redISub(s), h = t.redMul(c);
        ...
        "use strict";
        var i = r(25), n = r(2), a = r(0), o = i.base, f = r(4).utils;
        ...
        a(s, o), e.exports = s, s.prototype.validate = function (e) {
            var t = e.normalize().x, r = t.redSqr(), i = r.redMul(t).redAdd(r.redMul(this.a)).redAdd(t);
            return 0 === i.redSqrt().redSqr().cmp(i)
        }, a(c, o.BasePoint), s.prototype.decodePoint = function (e, t) {
            ...
            var r = this.x.redAdd(this.z), i = this.x.redSub(this.z), n = e.x.redAdd(e.z),
                a = e.x.redSub(e.z).redMul(r), o = n.redMul(i), f = t.z.redMul(a.redAdd(o).redSqr()),
        ...
        o(c, f), e.exports = c, c.prototype._mulA = function (e) {
            ...
            var r = e.redSqr(), i = this.c2.redSub(this.a.redMul(r)),
                n = this.one.redSub(this.c2.redMul(this.d).redMul(r)), o = i.redMul(n.redInvm()), f = o.redSqrt();
            ...
            return 0 === i.cmp(n)
        }, o(h, f.BasePoint), c.prototype.pointFromJSON = function (e) {
            ...
            var i = this.curve._mulA(e), n = this.x.redAdd(this.y).redSqr().redISub(e).redISub(t), a = i.redAdd(t),
                o = a.redSub(r), f = i.redSub(t), s = n.redMul(o), c = a.redMul(f), h = n.redMul(f), d = o.redMul(a);
            ...
            if (this.curve.twisted) {
                ...
                if (this.zOne) e = i.redSub(n).redSub(a).redMul(o.redSub(this.curve.two)), t = o.redMul(c.redSub(a)), r = o.redSqr().redSub(o).redSub(o); else {
                    var f = this.z.redSqr(), s = o.redSub(f).redISub(f);
                    e = i.redSub(n).redISub(a).redMul(s), t = o.redMul(c.redSub(a)), r = o.redMul(s)
                }
            } else {
                var c = n.redAdd(a);
                f = this.curve._mulC(this.c.redMul(this.z)).redSqr(), s = c.redSub(f).redSub(f);
                e = this.curve._mulC(i.redISub(c)).redMul(s), t = this.curve._mulC(c).redMul(n.redISub(a)), r = c.redMul(s)
            }
            ...
            var t = this.y.redSub(this.x).redMul(e.y.redSub(e.x)), r = this.y.redAdd(this.x).redMul(e.y.redAdd(e.x)),
                ...
                o = n.redSub(i), f = n.redAdd(i), s = r.redAdd(t), c = a.redMul(o), h = f.redMul(s), d = a.redMul(s),
                u = o.redMul(f);
            return this.curve.point(c, h, u, d)
        }, h.prototype._projAdd = function (e) {
            var t, r, i = this.z.redMul(e.z), n = i.redSqr(), a = this.x.redMul(e.x), o = this.y.redMul(e.y),
                f = this.curve.d.redMul(a).redMul(o), s = n.redSub(f), c = n.redAdd(f),
                h = this.x.redAdd(this.y).redMul(e.x.redAdd(e.y)).redISub(a).redISub(o), d = i.redMul(s).redMul(h);
            return this.curve.twisted ? (t = i.redMul(c).redMul(o.redSub(this.curve._mulA(a))), r = s.redMul(c)) : (t = i.redMul(c).redMul(o.redSub(a)), r = this.curve._mulC(s).redMul(c)), this.curve.point(d, t, r)
        }, h.prototype.add = function (e) {
        ...
        "use strict";
        var i, n = t, a = r(39), o = r(4), f = o.utils.assert;

        function s(e) {
            "short" === e.type ? this.curve = new o.curve.short(e) : "edwards" === e.type ? this.curve = new o.curve.edwards(e) : this.curve = new o.curve.mont(e), this.g = this.curve.g, this.n = this.curve.n, this.hash = e.hash, f(this.g.validate(), "Invalid curve"), f(this.g.mul(this.n).isInfinity(), "Invalid curve, G*N != O")
        }
        ...
        "use strict";
        var i = r(6), n = r(18), a = r(63), o = i.rotl32, f = i.sum32, s = i.sum32_5, c = a.ft_1, h = n.BlockHash,
        ...
        i.inherits(u, h), e.exports = u, u.blockSize = 512, u.outSize = 160, u.hmacStrength = 80, u.padLength = 64, u.prototype._update = function (e, t) {
            for (var r = this.W, i = 0; i < 16; i++) r[i] = e[t + i];
            for (; i < r.length; i++) r[i] = o(r[i - 3] ^ r[i - 8] ^ r[i - 14] ^ r[i - 16], 1);
            var n = this.h[0], a = this.h[1], h = this.h[2], u = this.h[3], l = this.h[4];
            for (i = 0; i < r.length; i++) {
                var p = ~~(i / 20), b = s(o(n, 5), c(p, a, h, u), l, r[i], d[p]);
                l = u, u = h, h = o(a, 30), a = n, n = b
            }
            this.h[0] = f(this.h[0], n), this.h[1] = f(this.h[1], a), this.h[2] = f(this.h[2], h), this.h[3] = f(this.h[3], u), this.h[4] = f(this.h[4], l)
        ...
        "use strict";
        var i = r(6), n = r(18), a = i.rotl32, o = i.sum32, f = i.sum32_3, s = i.sum32_4, c = n.BlockHash;
        ...
        i.inherits(h, c), t.ripemd160 = h, h.blockSize = 512, h.outSize = 160, h.hmacStrength = 192, h.padLength = 64, h.prototype._update = function (e, t) {
            for (var r = this.h[0], i = this.h[1], n = this.h[2], c = this.h[3], h = this.h[4], v = r, g = i, w = n, _ = c, S = h, M = 0; M < 80; M++) {
                var E = o(a(s(r, d(M, i, n, c), e[p[M] + t], u(M)), y[M]), h);
                r = h, h = c, c = a(n, 10), n = i, i = E, E = o(a(s(v, d(79 - M, g, w, _), e[b[M] + t], l(M)), m[M]), S), v = S, S = _, _ = a(w, 10), w = g, g = E
            }
            E = f(this.h[1], n, _), this.h[1] = f(this.h[2], c, S), this.h[2] = f(this.h[3], h, v), this.h[3] = f(this.h[4], r, g), this.h[4] = f(this.h[0], i, w), this.h[0] = E
        ...
        "use strict";
        var i = r(2), n = r(145), a = r(4), o = a.utils.assert, f = r(146), s = r(147);

        function c(e) {
            if (!(this instanceof c)) return new c(e);
            "string" == typeof e && (o(a.curves.hasOwnProperty(e), "Unknown curve " + e), e = a.curves[e]), e instanceof a.curves.PresetCurve && (e = {curve: e}), this.curve = e.curve.curve, this.n = this.curve.n, this.nh = this.n.ushrn(1), this.g = this.curve.g, this.g = e.curve.g, this.g.precompute(e.curve.n.bitLength() + 1), this.hash = e.hash || e.curve.hash
        }
        ...
        e.exports = c, c.prototype.keyPair = function (e) {
            ...
            for (var o = this.n.byteLength(), f = t.getPrivate().toArray("be", o), c = e.toArray("be", o), h = new n({
                hash: this.hash,
                entropy: f,
                nonce: c,
                pers: a.pers,
                    ...
                    if (!p.isInfinity()) {
                        ...
                        if (0 !== y.cmpn(0)) {
                            ...
                            if (0 !== (m = m.umod(this.n)).cmpn(0)) {
                                ...
                                return a.canonical && m.cmp(this.nh) > 0 && (m = this.n.sub(m), v ^= 1), new s({
                                    r: y,
                                    s: m,
                                    recoveryParam: v
                                })
            ...
            var a = (t = new s(t, "hex")).r, o = t.s;
            if (a.cmpn(1) < 0 || a.cmp(this.n) >= 0) return !1;
            if (o.cmpn(1) < 0 || o.cmp(this.n) >= 0) return !1;
            var f, c = o.invm(this.n), h = c.mul(e).umod(this.n), d = c.mul(a).umod(this.n);
            return this.curve._maxwellTrick ? !(f = this.g.jmulAdd(h, r.getPublic(), d)).isInfinity() && f.eqXToP(a) : !(f = this.g.mulAdd(h, r.getPublic(), d)).isInfinity() && 0 === f.getX().umod(this.n).cmp(a)
        }, c.prototype.recoverPubKey = function (e, t, r, n) {
            o((3 & r) === r, "The recovery param is more than two bits"), t = new s(t, n);
        ...
        "use strict";
        var i = r(2), n = r(4).utils, a = n.assert;
        ...
        function f(e, t) {
            var r = e[t.place++];
            if (!(128 & r)) return r;
            for (var i = 15 & r, n = 0, a = 0, o = t.place; a < i; a++, o++) n <<= 8, n |= e[o];
            return t.place = o, n
        }
        ...
        e.exports = o, o.prototype._importDER = function (e, t) {
            ...
            return 0 === o[0] && 128 & o[1] && (o = o.slice(1)), 0 === c[0] && 128 & c[1] && (c = c.slice(1)), this.r = new i(o), this.s = new i(c), this.recoveryParam = null, !0
            ...
            var a = i.concat(r), o = [48];
            return c(o, a.length), o = o.concat(a), n.encode(o, e)
        }
    }, function (e, t, r) {
        "use strict";
        var i = r(39), n = r(4), a = n.utils, o = a.assert, f = a.parseBytes, s = r(149), c = r(150);

        function h(e) {
            if (o("ed25519" === e, "only tested with ed25519 so far"), !(this instanceof h)) return new h(e);
            e = n.curves[e].curve;
        ...
        e.exports = h, h.prototype.sign = function (e, t) {
            ...
            var r = this.keyFromSecret(t), i = this.hashInt(r.messagePrefix(), e), n = this.g.mul(i),
                a = this.encodePoint(n), o = this.hashInt(a, r.pubBytes(), e).mul(r.priv()),
        ...
        "use strict";
        var i = r(4).utils, n = i.assert, a = i.parseBytes, o = i.cachedProperty;
        ...
        "use strict";
        var i = r(2), n = r(4).utils, a = n.assert, o = n.cachedProperty, f = n.parseBytes;
        ...
        var i = r(20).Reporter, n = r(20).EncoderBuffer, a = r(20).DecoderBuffer, o = r(5),
        ...
        c.prototype.clone = function () {
            ...
            return r.obj && o && (n = e.leaveObject(i)), null === r.key || null === n && !0 !== o ? null !== f && e.exitKey(f) : e.leaveKey(f, r.key, n), n
            ...
            var o = null, f = !1;
            if (n.any) a = this._createEncoderBuffer(e); else if (n.choice) a = this._encodeChoice(e, t); else if (n.contains) o = this._getUse(n.contains, r)._encode(e, t), f = !0; else if (n.children) o = n.children.map(function (r) {
                ...
                return e
            }), o = this._createEncoderBuffer(o); else if ("seqof" === n.tag || "setof" === n.tag) {
                if (!n.args || 1 !== n.args.length) return t.error("Too many args for : " + n.tag);
                if (!Array.isArray(e)) return t.error("seqof/setof, but data is not Array");
                var s = this.clone();
                s._baseState.implicit = null, o = this._createEncoderBuffer(e.map(function (r) {
                    var i = this._baseState;
                    return this._getUse(i.args[0], e)._encode(r, t)
                }, s))
            } else null !== n.use ? a = this._getUse(n.use, r)._encode(e, t) : (o = this._encodePrimitive(n.tag, e), f = !0);
            if (!n.any && null === n.choice) {
                var c = null !== n.implicit ? n.implicit : n.tag, h = null === n.implicit ? "universal" : "context";
                null === c ? null === n.use && t.error("Tag could be omitted only for .use()") : null === n.use && (a = this._encodeComposite(c, f, h, o))
            }
        ...
        i(o, a), e.exports = o, o.prototype.decode = function (e, t) {
            for (var r = e.toString().split(/[\r\n]+/g), i = t.label.toUpperCase(), o = /^-----(BEGIN|END) ([^-]+)-----$/, f = -1, s = -1, c = 0; c < r.length; c++) {
                var h = r[c].match(o);
                if (null !== h && h[2] === i) {
                    if (-1 !== f) {
                        if ("END" !== h[1]) break;
            ...
            if (-1 === f || -1 === s) throw new Error("PEM section not found for: " + i);
        ...
        var i = r(19), n = i.define("Time", function () {
            ...
            this.seq().obj(this.key("version").explicit(0).int(), this.key("serialNumber").int(), this.key("signature").use(o), this.key("issuer").use(h), this.key("validity").use(d), this.key("subject").use(h), this.key("subjectPublicKeyInfo").use(f), this.key("issuerUniqueID").implicit(1).bitstr().optional(), this.key("subjectUniqueID").implicit(2).bitstr().optional(), this.key("extensions").explicit(3).seqof(u).optional())
        ...
        (function (t) {
            var i = /Proc-Type: 4,ENCRYPTED\n\r?DEK-Info: AES-((?:128)|(?:192)|(?:256))-CBC,([0-9A-H]+)\n\r?\n\r?([0-9A-z\n\r\+\/\=]+)\n\r?/m,
                ...
                o = r(23), f = r(35);
            e.exports = function (e, r) {
                var s, c = e.toString(), h = c.match(i);
                if (h) {
                    var d = "aes" + h[1], u = new t(h[2], "hex"), l = new t(h[3].replace(/\r?\n/g, ""), "base64"),
                        p = o(r, u.slice(0, 8), parseInt(h[1], 10)).key, b = [], y = f.createDecipheriv(d, p, u);
                    b.push(y.update(l)), b.push(y.final()), s = t.concat(b)
                } else {
                    var m = c.match(a);
                    s = new t(m[2].replace(/\r?\n/g, ""), "base64")
                }
        ...
        (function (t) {
            var i = r(2), n = r(4).ec, a = r(26), o = r(70);
            ...
            e.exports = function (e, r, s, c, h) {
                ...
                if ("dsa" === d.type) {
                    ...
                    return function (e, t, r) {
                        var n = r.data.p, o = r.data.q, s = r.data.g, c = r.data.pub_key,
                            h = a.signature.decode(e, "der"), d = h.s, u = h.r;
                        f(d, o), f(u, o);
                        var l = i.mont(n), p = d.invm(o);
                        return 0 === s.toRed(l).redPow(new i(t).mul(p).mod(o)).fromRed().mul(c.toRed(l).redPow(u.mul(p).mod(o)).fromRed()).mod(n).mod(o).cmp(u)
                    }(e, r, d)
                }
                if ("rsa" !== c && "ecdsa/rsa" !== c) throw new Error("wrong public key type");
                r = t.concat([h, r]);
                for (var u = d.modulus.byteLength(), l = [1], p = 0; r.length + l.length + 2 < u;) l.push(255), p++;
                l.push(0);
                for (var b = -1; ++b < r.length;) l.push(r[b]);
                l = new t(l);
                var y = i.mont(d.modulus);
                e = (e = new i(e).toRed(y)).redPow(new i(d.publicExponent)), e = new t(e.fromRed().toArray());
                var m = p < 8 ? 1 : 0;
                for (u = Math.min(e.length, l.length), e.length !== l.length && (m = 1), b = -1; ++b < u;) m |= e[b] ^ l[b];
                return 0 === m
            }
        }).call(t, r(3).Buffer)
    }, function (e, t, r) {
        (function (t) {
            ...
            a.p224 = a.secp224r1, a.p256 = a.secp256r1 = a.prime256v1, a.p192 = a.secp192r1 = a.prime192v1, a.p384 = a.secp384r1, a.p521 = a.secp521r1, o.prototype.generateKeys = function (e, t) {
                ...
                return r = r || "utf8", t.isBuffer(e) || (e = new t(e, r)), f(this.curve.keyFromPublic(e).getPublic().mul(this.keys.getPrivate()).getX(), i, this.curveType.byteLength)
        ...
        (function (t) {
            var i = r(26), n = r(13), a = r(15), o = r(71), f = r(72), s = r(2), c = r(73), h = r(38);
            e.exports = function (e, r, d) {
                var u;
                u = e.padding ? e.padding : d ? 1 : 4;
                var l, p = i(e);
                if (4 === u) l = function (e, r) {
                    var i = e.modulus.byteLength(), c = r.length, h = a("sha1").update(new t("")).digest(),
                        d = h.length, u = 2 * d;
                    if (c > i - u - 2) throw new Error("message too long");
                    var l = new t(i - c - u - 2);
                    l.fill(0);
                    var p = i - d - 1, b = n(d), y = f(t.concat([h, l, new t([1]), r], p), o(b, p)), m = f(b, o(y, d));
                    return new s(t.concat([new t([0]), m, y], i))
                }(p, r); else if (1 === u) l = function (e, r, i) {
                    var a, o = r.length, f = e.modulus.byteLength();
                    if (o > f - 11) throw new Error("message too long");
                    i ? (a = new t(f - o - 3)).fill(255) : a = function (e, r) {
                        var i, a = new t(e), o = 0, f = n(2 * e), s = 0;
                        for (; o < e;) s === f.length && (f = n(2 * e), s = 0), (i = f[s++]) && (a[o++] = i);
                        return a
                    }(f - o - 3);
                    return new s(t.concat([new t([0, i ? 1 : 2]), a, new t([0]), r], f))
                }(p, r, d); else {
                    if (3 !== u) throw new Error("unknown padding");
                    if ((l = new s(r)).cmp(p.modulus) >= 0) throw new Error("data too long for modulus")
                }
                return d ? h(l, p) : c(l, p)
            }
        }).call(t, r(3).Buffer)
    }, function (e, t, r) {
        (function (t) {
            var i = r(26), n = r(71), a = r(72), o = r(2), f = r(38), s = r(15), c = r(73);
            e.exports = function (e, r, h) {
                var d;
                d = e.padding ? e.padding : h ? 1 : 4;
                var u, l = i(e), p = l.modulus.byteLength();
                if (r.length > p || new o(r).cmp(l.modulus) >= 0) throw new Error("decryption error");
                u = h ? c(new o(r), l) : f(r, l);
                var b = new t(p - u.length);
                if (b.fill(0), u = t.concat([b, u], p), 4 === d) return function (e, r) {
                    e.modulus;
                    var i = e.modulus.byteLength(), o = (r.length, s("sha1").update(new t("")).digest()), f = o.length;
                    if (0 !== r[0]) throw new Error("decryption error");
                    var c = r.slice(1, f + 1), h = r.slice(f + 1), d = a(c, n(h, f)), u = a(h, n(d, i - f - 1));
                    if (function (e, r) {
                            e = new t(e), r = new t(r);
                            var i = 0, n = e.length;
                            ...
                            for (; ++a < n;) i += e[a] ^ r[a];
                            return i
                        }(o, u.slice(0, f))) throw new Error("decryption error");
                    var l = f;
                    for (; 0 === u[l];) l++;
        ...
        (function (e, i) {
            ...
            var a = r(1), o = r(13), f = a.Buffer, s = a.kMaxLength, c = e.crypto || e.msCrypto,
                h = Math.pow(2, 32) - 1;
            ...
            function l(e, t, r, n) {
                if (i.browser) {
                    var a = e.buffer, f = new Uint8Array(a, t, r);
                    return c.getRandomValues(f), n ? void i.nextTick(function () {
                        n(null, e)
                    }) : e
                }
            ...
            c && c.getRandomValues || !i.browser ? (t.randomFill = function (t, r, i, n) {
                ...
                return d(r, t.length), u(i, r, t.length), l(t, r, i, n)
        ...
        "use strict";
        const i = r(173), n = r(77), a = r(40);
        e.exports = {Curve: i, Point: n, Scalar: a}
    }, function (e, t, r) {
        "use strict";
        const i = r(40), n = r(77), a = r(11), o = new (0, r(4).eddsa)("ed25519"), f = r(2).red(o.curve.n), s = r(10);
        e.exports = class extends s.Group {
            constructor() {
                super(), this.curve = o.curve, this.orderRed = f
            }
            ...
            newKey() {
                let e = a.randomBytes(32), t = a.createHash("sha512");
                t.update(e);
        ...
        e.exports.sign = function (e, t, r) {
            ...
            const n = e.scalar().pick(), o = e.point().mul(n, null).marshalBinary(),
                f = a(e, o, e.point().mul(t, null).marshalBinary(), r), s = e.scalar().mul(t, f);
            s.add(s, n);
            const c = s.marshalBinary(), h = new Uint8Array(o.length + c.length);
            return h.set(o), h.set(c, o.length), h
            ...
            const o = e.pointLen(), f = o + e.scalarLen();
            if (n.length != f) return !1;
            const s = n.slice(0, o), c = e.point();
            c.unmarshalBinary(s);
            const h = n.slice(o, n.lengh), d = e.scalar();
            d.unmarshalBinary(h);
            const u = a(e, s, t.marshalBinary(), r), l = e.point().mul(d, null), p = e.point().mul(u, t);
            return p.add(p, c), !!p.equal(l)
        }, e.exports.hashSchnorr = a
    }])
});